...
// via /mnt/local/smack-project/smack/bin/smack -x=svcomp --time-limit 1800 /proj/SMACK/sv-benchmarks/c/ldv-linux-3.4-simple/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c --verifier-options  /bopt:boolControlVC /bopt:z3opt:SMT.MBQI=false /nonUniformUnfolding /trackAllVars /useArrayTheory --unroll 16
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 98516));
...
const __kcrctab_w1_ds2760_read: ref;
axiom (__kcrctab_w1_ds2760_read == $sub.ref(0, 4200));
const __ksymtab_w1_ds2760_read: ref;
axiom (__ksymtab_w1_ds2760_read == $sub.ref(0, 5240));
const __kcrctab_w1_ds2760_write: ref;
axiom (__kcrctab_w1_ds2760_write == $sub.ref(0, 6272));
const __ksymtab_w1_ds2760_write: ref;
axiom (__ksymtab_w1_ds2760_write == $sub.ref(0, 7312));
const __kcrctab_w1_ds2760_store_eeprom: ref;
axiom (__kcrctab_w1_ds2760_store_eeprom == $sub.ref(0, 8344));
const __ksymtab_w1_ds2760_store_eeprom: ref;
axiom (__ksymtab_w1_ds2760_store_eeprom == $sub.ref(0, 9384));
const __kcrctab_w1_ds2760_recall_eeprom: ref;
axiom (__kcrctab_w1_ds2760_recall_eeprom == $sub.ref(0, 10416));
const __ksymtab_w1_ds2760_recall_eeprom: ref;
axiom (__ksymtab_w1_ds2760_recall_eeprom == $sub.ref(0, 11456));
const {:count 12} __mod_license203: ref;
axiom (__mod_license203 == $sub.ref(0, 12492));
const {:count 48} __mod_author204: ref;
axiom (__mod_author204 == $sub.ref(0, 13564));
const {:count 59} __mod_description205: ref;
axiom (__mod_description205 == $sub.ref(0, 14647));
const {:count 24} __kstrtab_w1_ds2760_recall_eeprom: ref;
axiom (__kstrtab_w1_ds2760_recall_eeprom == $sub.ref(0, 15695));
const w1_ds2760_bin_attr: ref;
axiom (w1_ds2760_bin_attr == $sub.ref(0, 16775));
const w1_ds2760_fops: ref;
axiom (w1_ds2760_fops == $sub.ref(0, 17815));
const w1_ds2760_family: ref;
axiom (w1_ds2760_family == $sub.ref(0, 18879));
const bat_ida: ref;
axiom (bat_ida == $sub.ref(0, 19959));
const {:count 23} __kstrtab_w1_ds2760_store_eeprom: ref;
axiom (__kstrtab_w1_ds2760_store_eeprom == $sub.ref(0, 21006));
const {:count 16} __kstrtab_w1_ds2760_write: ref;
axiom (__kstrtab_w1_ds2760_write == $sub.ref(0, 22046));
const {:count 15} __kstrtab_w1_ds2760_read: ref;
axiom (__kstrtab_w1_ds2760_read == $sub.ref(0, 23085));
const {:count 15} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 24124));
const {:count 9} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 25157));
const __crc_w1_ds2760_recall_eeprom: ref;
axiom (__crc_w1_ds2760_recall_eeprom == $sub.ref(0, 32776));
const __crc_w1_ds2760_store_eeprom: ref;
axiom (__crc_w1_ds2760_store_eeprom == $sub.ref(0, 32784));
const __crc_w1_ds2760_write: ref;
axiom (__crc_w1_ds2760_write == $sub.ref(0, 32792));
const __crc_w1_ds2760_read: ref;
axiom (__crc_w1_ds2760_read == $sub.ref(0, 32800));
const .str: ref;
axiom (.str == $sub.ref(0, 26270));
const {:count 14} .str.2.8: ref;
axiom (.str.2.8 == $sub.ref(0, 27308));
const w1_ds2760_recall_eeprom: ref;
axiom (w1_ds2760_recall_eeprom == $sub.ref(0, 28340));
procedure  w1_ds2760_recall_eeprom($p0: ref, $i1: i32)
  returns ($r: i32)
{
  var $i2: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata %struct.device* %0, i64 0, metadata !1090, metadata !1091), !dbg !1092, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1115, 9} true;
  assume {:verifier.code 0} true;
  call $i2 := w1_ds2760_eeprom_cmd($p0, $i1, 184);
  // WARNING: %3 = call i32 @w1_ds2760_eeprom_cmd(%struct.device* %0, i32 %1, i32 184), !dbg !1096, !verifier.code !1093
  call {:cexpr "tmp"} boogie_si_record_i32($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1117, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
}
const w1_ds2760_eeprom_cmd: ref;
axiom (w1_ds2760_eeprom_cmd == $sub.ref(0, 29372));
procedure  w1_ds2760_eeprom_cmd($p0: ref, $i1: i32, $i2: i32)
  returns ($r: i32)
{
  var $i3: i64;
  var $i4: i64;
  ...
  var $i13: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata %struct.device* %0, i64 0, metadata !1105, metadata !1091), !dbg !1106, !verifier.code !1093
  // WARNING: call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !1107, metadata !1091), !dbg !1108, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1050, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $p2i.ref.i64($0.ref);
  // WARNING: %4 = ptrtoint %struct.w1_slave* null to i64, !dbg !1102, !verifier.code !1093
  call {:cexpr "__cil_tmp8"} boogie_si_record_i64($i3);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1051, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i64($i3, 112);
  // WARNING: %5 = add i64 %4, 112, !dbg !1106, !verifier.code !1093
  call {:cexpr "__cil_tmp9"} boogie_si_record_i64($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1052, 17} true;
  assume {:verifier.code 0} true;
  $p5 := $i2p.i64.ref($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1053, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $p2i.ref.i32($p5);
  // WARNING: %7 = ptrtoint %struct.device* %6 to i32, !dbg !1112, !verifier.code !1093
  call {:cexpr "__cil_tmp11"} boogie_si_record_i32($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1054, 17} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1055, 29} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i32.i64($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1055, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1056, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $bitcast.ref.ref($p10);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1057, 9} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.ref($p0, $0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1057, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1058, 5} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i32(0, 22);
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1099, 1} true;
  assume {:verifier.code 0} true;
  $r := $i13;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1063, 17} true;
  assume {:verifier.code 0} true;
  $i14 := $p2i.ref.i64($p11);
  // WARNING: %17 = ptrtoint %struct.w1_slave* %12 to i64, !dbg !1129, !verifier.code !1093
  call {:cexpr "__cil_tmp14"} boogie_si_record_i64($i14);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1064, 29} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i64($i14, 88);
  // WARNING: %18 = add i64 %17, 88, !dbg !1133, !verifier.code !1093
  call {:cexpr "__cil_tmp15"} boogie_si_record_i64($i15);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1065, 19} true;
  assume {:verifier.code 0} true;
  $p16 := $i2p.i64.ref($i15);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1065, 17} true;
  assume {:verifier.code 0} true;
  $p17 := $load.ref($M.0, $p16);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1066, 17} true;
  assume {:verifier.code 0} true;
  $i18 := $p2i.ref.i64($p17);
  // WARNING: %21 = ptrtoint %struct.w1_master* %20 to i64, !dbg !1140, !verifier.code !1093
  call {:cexpr "__cil_tmp17"} boogie_si_record_i64($i18);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1067, 29} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i64($i18, 144);
  // WARNING: %22 = add i64 %21, 144, !dbg !1143, !verifier.code !1093
  call {:cexpr "__cil_tmp18"} boogie_si_record_i64($i19);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1068, 17} true;
  assume {:verifier.code 0} true;
  $p20 := $i2p.i64.ref($i19);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1069, 3} true;
  assume {:verifier.code 0} true;
  call mutex_lock($p20);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1070, 9} true;
  assume {:verifier.code 0} true;
  call $i21 := w1_reset_select_slave($p11);
  // WARNING: %24 = call i32 @w1_reset_select_slave(%struct.w1_slave* %12), !dbg !1150, !verifier.code !1093
  call {:cexpr "tmp"} boogie_si_record_i32($i21);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1072, 11} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i32($i21, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1072, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i22 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1074, 19} true;
  assume {:verifier.code 0} true;
  $i23 := $p2i.ref.i64($p11);
  // WARNING: %27 = ptrtoint %struct.w1_slave* %12 to i64, !dbg !1156, !verifier.code !1093
  call {:cexpr "__cil_tmp20"} boogie_si_record_i64($i23);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1075, 31} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i64($i23, 88);
  // WARNING: %28 = add i64 %27, 88, !dbg !1161, !verifier.code !1093
  call {:cexpr "__cil_tmp21"} boogie_si_record_i64($i24);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1076, 21} true;
  assume {:verifier.code 0} true;
  $p25 := $i2p.i64.ref($i24);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1076, 19} true;
  assume {:verifier.code 0} true;
  $p26 := $load.ref($M.0, $p25);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1077, 19} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i32.i8($i2);
  // WARNING: %31 = trunc i32 %2 to i8, !dbg !1168, !verifier.code !1093
  call {:cexpr "__cil_tmp23"} boogie_si_record_i8($i27);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1078, 5} true;
  assume {:verifier.code 0} true;
  call w1_write_8($p26, $i27);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1079, 19} true;
  assume {:verifier.code 0} true;
  $i28 := $p2i.ref.i64($p11);
  // WARNING: %32 = ptrtoint %struct.w1_slave* %12 to i64, !dbg !1172, !verifier.code !1093
  call {:cexpr "__cil_tmp24"} boogie_si_record_i64($i28);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1080, 31} true;
  assume {:verifier.code 0} true;
  $i29 := $add.i64($i28, 88);
  // WARNING: %33 = add i64 %32, 88, !dbg !1175, !verifier.code !1093
  call {:cexpr "__cil_tmp25"} boogie_si_record_i64($i29);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1081, 21} true;
  assume {:verifier.code 0} true;
  $p30 := $i2p.i64.ref($i29);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1081, 19} true;
  assume {:verifier.code 0} true;
  $p31 := $load.ref($M.0, $p30);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1082, 19} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i32.i8($i1);
  // WARNING: %36 = trunc i32 %1 to i8, !dbg !1182, !verifier.code !1093
  call {:cexpr "__cil_tmp27"} boogie_si_record_i8($i32);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1083, 5} true;
  assume {:verifier.code 0} true;
  call w1_write_8($p31, $i32);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1085, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i22 == 1));
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1089, 17} true;
  assume {:verifier.code 0} true;
  $i33 := $p2i.ref.i64($p11);
  // WARNING: %39 = ptrtoint %struct.w1_slave* %12 to i64, !dbg !1187, !verifier.code !1093
  call {:cexpr "__cil_tmp28"} boogie_si_record_i64($i33);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1090, 29} true;
  assume {:verifier.code 0} true;
  $i34 := $add.i64($i33, 88);
  // WARNING: %40 = add i64 %39, 88, !dbg !1191, !verifier.code !1093
  call {:cexpr "__cil_tmp29"} boogie_si_record_i64($i34);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1091, 19} true;
  assume {:verifier.code 0} true;
  $p35 := $i2p.i64.ref($i34);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1091, 17} true;
  assume {:verifier.code 0} true;
  $p36 := $load.ref($M.0, $p35);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1092, 17} true;
  assume {:verifier.code 0} true;
  $i37 := $p2i.ref.i64($p36);
  // WARNING: %43 = ptrtoint %struct.w1_master* %42 to i64, !dbg !1198, !verifier.code !1093
  call {:cexpr "__cil_tmp31"} boogie_si_record_i64($i37);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1093, 29} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i64($i37, 144);
  // WARNING: %44 = add i64 %43, 144, !dbg !1201, !verifier.code !1093
  call {:cexpr "__cil_tmp32"} boogie_si_record_i64($i38);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1094, 17} true;
  assume {:verifier.code 0} true;
  $p39 := $i2p.i64.ref($i38);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1095, 3} true;
  assume {:verifier.code 0} true;
  call mutex_unlock($p39);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1097, 3} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
  goto $bb3;
}
const mutex_lock: ref;
axiom (mutex_lock == $sub.ref(0, 30404));
procedure  mutex_lock($p0: ref)
{
  var $i1: i32;
  var $i2: i1;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1589, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1589, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1589, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1591, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1593, 5} true;
  assume {:verifier.code 0} true;
  call ldv_blast_assert();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1596, 13} true;
  assume {:verifier.code 0} true;
  $M.1 := 2;
  call {:cexpr "ldv_mutex"} boogie_si_record_i32(2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1597, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const w1_reset_select_slave: ref;
axiom (w1_reset_select_slave == $sub.ref(0, 31436));
procedure  w1_reset_select_slave($p0: ref)
  returns ($r: i32);
const w1_write_8: ref;
axiom (w1_write_8 == $sub.ref(0, 32468));
procedure  w1_write_8($p0: ref, $i1: i8);
const mutex_unlock: ref;
axiom (mutex_unlock == $sub.ref(0, 33500));
procedure  mutex_unlock($p0: ref)
{
  var $i1: i32;
  var $i2: i1;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1626, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1626, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1626, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1628, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1630, 5} true;
  assume {:verifier.code 0} true;
  call ldv_blast_assert();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1633, 13} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "ldv_mutex"} boogie_si_record_i32(1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1634, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const ldv_blast_assert: ref;
axiom (ldv_blast_assert == $sub.ref(0, 34532));
procedure  ldv_blast_assert()
{
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1512, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1513, 10} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1515, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const w1_ds2760_add_slave: ref;
axiom (w1_ds2760_add_slave == $sub.ref(0, 35564));
procedure  w1_ds2760_add_slave($p0: ref)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1184, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := ida_simple_get(bat_ida, 0, 0, 208);
  // WARNING: %2 = call i32 @ida_simple_get(%struct.ida* @bat_ida, i32 0, i32 0, i32 208), !dbg !1092, !verifier.code !1091
  call {:cexpr "id"} boogie_si_record_i32($i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1186, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1186, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1188, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i1;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1245, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1193, 10} true;
  assume {:verifier.code 0} true;
  call $p4 := platform_device_alloc(.str.1, $i1);
  assume $isExternal($p4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1195, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.ref($p4, $0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1195, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1197, 5} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32(0, 12);
  goto $bb7;
$bb7:
  assume {:verifier.code 0} true;
  // WARNING: %.1 = phi i32 [ %.0, %36 ], [ -12, %9 ], !verifier.code !1091
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1242, 3} true;
  assume {:verifier.code 0} true;
  call ida_simple_remove(bat_ida, $i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1243, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i6;
  goto $bb3;
$bb8:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1202, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $p2i.ref.i64($p4);
  // WARNING: %12 = ptrtoint %struct.platform_device* %7 to i64, !dbg !1113, !verifier.code !1091
  call {:cexpr "__cil_tmp5"} boogie_si_record_i64($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1203, 27} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i64($i7, 16);
  // WARNING: %13 = add i64 %12, 16, !dbg !1117, !verifier.code !1091
  call {:cexpr "__cil_tmp6"} boogie_si_record_i64($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1204, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $p2i.ref.i64($p0);
  // WARNING: %14 = ptrtoint %struct.w1_slave* %0 to i64, !dbg !1120, !verifier.code !1091
  call {:cexpr "__cil_tmp7"} boogie_si_record_i64($i9);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1205, 27} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i64($i9, 112);
  // WARNING: %15 = add i64 %14, 112, !dbg !1123, !verifier.code !1091
  call {:cexpr "__cil_tmp8"} boogie_si_record_i64($i10);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1206, 37} true;
  assume {:verifier.code 0} true;
  $p11 := $i2p.i64.ref($i10);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1206, 5} true;
  assume {:verifier.code 0} true;
  $p12 := $i2p.i64.ref($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1206, 35} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p12, $p11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1207, 9} true;
  assume {:verifier.code 0} true;
  call $i13 := platform_device_add($p4);
  // WARNING: %18 = call i32 @platform_device_add(%struct.platform_device* %7), !dbg !1129, !verifier.code !1091
  call {:cexpr "ret"} boogie_si_record_i32($i13);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1209, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i13, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1209, 7} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume ($i14 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1210, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $i13;
  goto $bb11;
$bb10:
...
$bb11:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1237, 3} true;
  assume {:verifier.code 0} true;
  call platform_device_unregister($p4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1238, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $i15;
  goto $bb7;
$bb12:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1216, 17} true;
  assume {:verifier.code 0} true;
  $i16 := $p2i.ref.i64($p0);
  // WARNING: %23 = ptrtoint %struct.w1_slave* %0 to i64, !dbg !1137, !verifier.code !1091
  call {:cexpr "__cil_tmp10"} boogie_si_record_i64($i16);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1217, 29} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i64($i16, 128);
  // WARNING: %24 = add i64 %23, 128, !dbg !1141, !verifier.code !1091
  call {:cexpr "__cil_tmp11"} boogie_si_record_i64($i17);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1218, 17} true;
  assume {:verifier.code 0} true;
  $p18 := $i2p.i64.ref($i17);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1220, 15} true;
  assume {:verifier.code 0} true;
  call $i19 := sysfs_create_bin_file($p18, w1_ds2760_bin_attr);
  // WARNING: %26 = call i32 @sysfs_create_bin_file(%struct.kobject* %25, %struct.bin_attribute* @w1_ds2760_bin_attr), !dbg !1149, !verifier.code !1091
  call {:cexpr "ret"} boogie_si_record_i32($i19);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1222, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $ne.i32($i19, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1222, 7} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i20 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1223, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $i19;
  goto $bb11;
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1228, 17} true;
  assume {:verifier.code 0} true;
  $i21 := $p2i.ref.i64($p0);
  // WARNING: %31 = ptrtoint %struct.w1_slave* %0 to i64, !dbg !1155, !verifier.code !1091
  call {:cexpr "__cil_tmp14"} boogie_si_record_i64($i21);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1229, 29} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i64($i21, 112);
  // WARNING: %32 = add i64 %31, 112, !dbg !1159, !verifier.code !1091
  call {:cexpr "__cil_tmp15"} boogie_si_record_i64($i22);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1230, 17} true;
  assume {:verifier.code 0} true;
  $p23 := $i2p.i64.ref($i22);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1231, 17} true;
  assume {:verifier.code 0} true;
  $p24 := $bitcast.ref.ref($p4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1232, 3} true;
  assume {:verifier.code 0} true;
  call $i25 := dev_set_drvdata($p23, $p24);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1234, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i19;
  goto $bb3;
}
const w1_ds2760_remove_slave: ref;
axiom (w1_ds2760_remove_slave == $sub.ref(0, 36596));
procedure  w1_ds2760_remove_slave($p0: ref)
{
  var $i1: i64;
  var $i2: i64;
  var $p3: ref;
  ...
  var $p12: ref;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1267, 16} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  // WARNING: %2 = ptrtoint %struct.w1_slave* %0 to i64, !dbg !1092, !verifier.code !1091
  call {:cexpr "__cil_tmp5"} boogie_si_record_i64($i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1268, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i64($i1, 112);
  // WARNING: %3 = add i64 %2, 112, !dbg !1097, !verifier.code !1091
  call {:cexpr "__cil_tmp6"} boogie_si_record_i64($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1269, 16} true;
  assume {:verifier.code 0} true;
  $p3 := $i2p.i64.ref($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1271, 9} true;
  assume {:verifier.code 0} true;
  call $p4 := dev_get_drvdata($p3);
  assume $isExternal($p4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1272, 10} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1273, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $p2i.ref.i64($p5);
  // WARNING: %7 = ptrtoint %struct.platform_device* %6 to i64, !dbg !1111, !verifier.code !1091
  call {:cexpr "__cil_tmp9"} boogie_si_record_i64($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1274, 28} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i64($i6, 8);
  // WARNING: %8 = add i64 %7, 8, !dbg !1114, !verifier.code !1091
  call {:cexpr "__cil_tmp10"} boogie_si_record_i64($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1275, 10} true;
  assume {:verifier.code 0} true;
  $p8 := $i2p.i64.ref($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1275, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p8);
  // WARNING: %10 = load i32, i32* %9, align 4, !dbg !1118, !verifier.code !1091
  call {:cexpr "id"} boogie_si_record_i32($i9);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1276, 3} true;
  assume {:verifier.code 0} true;
  call platform_device_unregister($p5);
  // WARNING: call void @platform_device_unregister(%struct.platform_device* %6), !dbg !1121, !verifier.code !1091
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1278, 3} true;
  assume {:verifier.code 0} true;
  call ida_simple_remove(bat_ida, $i9);
  // WARNING: call void @ida_simple_remove(%struct.ida* @bat_ida, i32 %10), !dbg !1124, !verifier.code !1091
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1280, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $p2i.ref.i64($p0);
  // WARNING: %11 = ptrtoint %struct.w1_slave* %0 to i64, !dbg !1127, !verifier.code !1091
  call {:cexpr "__cil_tmp13"} boogie_si_record_i64($i10);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1281, 29} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i64($i10, 128);
  // WARNING: %12 = add i64 %11, 128, !dbg !1130, !verifier.code !1091
  call {:cexpr "__cil_tmp14"} boogie_si_record_i64($i11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1282, 17} true;
  assume {:verifier.code 0} true;
  $p12 := $i2p.i64.ref($i11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1284, 3} true;
  assume {:verifier.code 0} true;
  call sysfs_remove_bin_file($p12, w1_ds2760_bin_attr);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1286, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const dev_get_drvdata: ref;
axiom (dev_get_drvdata == $sub.ref(0, 37628));
procedure  dev_get_drvdata($p0: ref)
  returns ($r: ref);
const platform_device_unregister: ref;
axiom (platform_device_unregister == $sub.ref(0, 38660));
procedure  platform_device_unregister($p0: ref);
const ida_simple_remove: ref;
axiom (ida_simple_remove == $sub.ref(0, 39692));
procedure  ida_simple_remove($p0: ref, $i1: i32);
const sysfs_remove_bin_file: ref;
axiom (sysfs_remove_bin_file == $sub.ref(0, 40724));
procedure  sysfs_remove_bin_file($p0: ref, $p1: ref);
const ida_simple_get: ref;
axiom (ida_simple_get == $sub.ref(0, 41756));
procedure  ida_simple_get($p0: ref, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32);
const platform_device_alloc: ref;
axiom (platform_device_alloc == $sub.ref(0, 42788));
procedure  platform_device_alloc($p0: ref, $i1: i32)
  returns ($r: ref);
const platform_device_add: ref;
axiom (platform_device_add == $sub.ref(0, 43820));
procedure  platform_device_add($p0: ref)
  returns ($r: i32);
const sysfs_create_bin_file: ref;
axiom (sysfs_create_bin_file == $sub.ref(0, 44852));
procedure  sysfs_create_bin_file($p0: ref, $p1: ref)
  returns ($r: i32);
const dev_set_drvdata: ref;
axiom (dev_set_drvdata == $sub.ref(0, 45884));
procedure  dev_set_drvdata($p0: ref, $p1: ref)
  returns ($r: i32);
const w1_ds2760_read_bin: ref;
axiom (w1_ds2760_read_bin == $sub.ref(0, 46916));
procedure  w1_ds2760_read_bin($p0: ref, $p1: ref, $p2: ref, $p3: ref, $i4: i64, $i5: i64)
  returns ($r: i64)
{
  var $i6: i64;
  var $i7: i64;
  ...
  var $i17: i64;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i8* %3, i64 0, metadata !1409, metadata !1091), !dbg !1410, !verifier.code !1093
  // WARNING: call void @llvm.dbg.value(metadata i64 %4, i64 0, metadata !1411, metadata !1091), !dbg !1412, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1138, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $p2i.ref.i64($0.ref);
  // WARNING: %7 = ptrtoint %struct.device* null to i64, !dbg !1106, !verifier.code !1091
  call {:cexpr "__cil_tmp11"} boogie_si_record_i64($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1139, 29} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i64($i6, 16);
  // WARNING: %8 = add i64 %7, 16, !dbg !1111, !verifier.code !1091
  call {:cexpr "__cil_tmp12"} boogie_si_record_i64($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1140, 17} true;
  assume {:verifier.code 0} true;
  $p8 := $i2p.i64.ref($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1141, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $p2i.ref.i32($p8);
  // WARNING: %10 = ptrtoint %struct.kobject* %9 to i32, !dbg !1117, !verifier.code !1091
  call {:cexpr "__cil_tmp14"} boogie_si_record_i32($i9);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1142, 17} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1143, 29} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i32.i64($i9);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1143, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1144, 9} true;
  assume {:verifier.code 0} true;
  $p14 := $bitcast.ref.ref($p13);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1145, 17} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i64.i32($i4);
  // WARNING: %16 = trunc i64 %4 to i32, !dbg !1129, !verifier.code !1091
  call {:cexpr "__cil_tmp17"} boogie_si_record_i32($i15);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1146, 9} true;
  assume {:verifier.code 0} true;
  call $i16 := w1_ds2760_read($p14, $p3, $i15, $i5);
  // WARNING: %17 = call i32 @w1_ds2760_read(%struct.device* %15, i8* %3, i32 %16, i64 %5), !dbg !1132, !verifier.code !1091
  call {:cexpr "tmp"} boogie_si_record_i32($i16);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1148, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $sext.i32.i64($i16);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1148, 3} true;
  assume {:verifier.code 0} true;
  $r := $i17;
  $exn := false;
  return;
}
const w1_ds2760_read: ref;
axiom (w1_ds2760_read == $sub.ref(0, 47948));
procedure  w1_ds2760_read($p0: ref, $p1: ref, $i2: i32, $i3: i64)
  returns ($r: i32)
{
  var $i4: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i8* %1, i64 0, metadata !1455, metadata !1091), !dbg !1456, !verifier.code !1093
  // WARNING: call void @llvm.dbg.value(metadata i32 %2, i64 0, metadata !1457, metadata !1091), !dbg !1458, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1000, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := w1_ds2760_io($p0, $p1, $i2, $i3, 0);
  // WARNING: %5 = call i32 @w1_ds2760_io(%struct.device* %0, i8* %1, i32 %2, i64 %3, i32 0), !dbg !1100, !verifier.code !1093
  call {:cexpr "tmp"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1002, 3} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
}
const w1_ds2760_io: ref;
axiom (w1_ds2760_io == $sub.ref(0, 48980));
procedure  w1_ds2760_io($p0: ref, $p1: ref, $i2: i32, $i3: i64, $i4: i32)
  returns ($r: i32)
{
  var $i5: i64;
  var $i6: i64;
  ...
  var $i15: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i8* %1, i64 0, metadata !1472, metadata !1091), !dbg !1473, !verifier.code !1093
  // WARNING: call void @llvm.dbg.value(metadata i32 %2, i64 0, metadata !1474, metadata !1091), !dbg !1475, !verifier.code !1093
  // WARNING: call void @llvm.dbg.value(metadata i64 %3, i64 0, metadata !1476, metadata !1091), !dbg !1477, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 895, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $p2i.ref.i64($0.ref);
  // WARNING: %6 = ptrtoint %struct.w1_slave* null to i64, !dbg !1106, !verifier.code !1093
  call {:cexpr "__cil_tmp11"} boogie_si_record_i64($i5);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 896, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i64($i5, 112);
  // WARNING: %7 = add i64 %6, 112, !dbg !1110, !verifier.code !1093
  call {:cexpr "__cil_tmp12"} boogie_si_record_i64($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 897, 17} true;
  assume {:verifier.code 0} true;
  $p7 := $i2p.i64.ref($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 898, 17} true;
  assume {:verifier.code 0} true;
  $i8 := $p2i.ref.i32($p7);
  // WARNING: %9 = ptrtoint %struct.device* %8 to i32, !dbg !1116, !verifier.code !1093
  call {:cexpr "__cil_tmp14"} boogie_si_record_i32($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 899, 17} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 900, 29} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 900, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 901, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 902, 9} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.ref($p0, $0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 902, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb1, $bb2;
$bb1:
...
$bb2:
  assume !(($i14 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 903, 5} true;
  assume {:verifier.code 0} true;
  $i15 := 0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 994, 1} true;
  assume {:verifier.code 0} true;
  $r := $i15;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 908, 17} true;
  assume {:verifier.code 0} true;
  $i16 := $p2i.ref.i64($p13);
  // WARNING: %19 = ptrtoint %struct.w1_slave* %14 to i64, !dbg !1133, !verifier.code !1093
  call {:cexpr "__cil_tmp17"} boogie_si_record_i64($i16);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 909, 29} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i64($i16, 88);
  // WARNING: %20 = add i64 %19, 88, !dbg !1137, !verifier.code !1093
  call {:cexpr "__cil_tmp18"} boogie_si_record_i64($i17);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 910, 19} true;
  assume {:verifier.code 0} true;
  $p18 := $i2p.i64.ref($i17);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 910, 17} true;
  assume {:verifier.code 0} true;
  $p19 := $load.ref($M.0, $p18);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 911, 17} true;
  assume {:verifier.code 0} true;
  $i20 := $p2i.ref.i64($p19);
  // WARNING: %23 = ptrtoint %struct.w1_master* %22 to i64, !dbg !1144, !verifier.code !1093
  call {:cexpr "__cil_tmp20"} boogie_si_record_i64($i20);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 912, 29} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i64($i20, 144);
  // WARNING: %24 = add i64 %23, 144, !dbg !1147, !verifier.code !1093
  call {:cexpr "__cil_tmp21"} boogie_si_record_i64($i21);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 913, 17} true;
  assume {:verifier.code 0} true;
  $p22 := $i2p.i64.ref($i21);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 914, 3} true;
  assume {:verifier.code 0} true;
  call mutex_lock($p22);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 916, 12} true;
  assume {:verifier.code 0} true;
  $i23 := $sgt.i32($i2, 64);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 916, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i23 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 918, 5} true;
  assume {:verifier.code 0} true;
  $i24 := 0;
  goto $bb7;
$bb6:
  assume !(($i23 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 920, 12} true;
  assume {:verifier.code 0} true;
  $i25 := $slt.i32($i2, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 920, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb8, $bb9;
$bb7:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 984, 17} true;
  assume {:verifier.code 0} true;
  $i67 := $p2i.ref.i64($p13);
  // WARNING: %82 = ptrtoint %struct.w1_slave* %14 to i64, !dbg !1288, !verifier.code !1093
  call {:cexpr "__cil_tmp52"} boogie_si_record_i64($i67);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 985, 29} true;
  assume {:verifier.code 0} true;
  $i68 := $add.i64($i67, 88);
  // WARNING: %83 = add i64 %82, 88, !dbg !1292, !verifier.code !1093
  call {:cexpr "__cil_tmp53"} boogie_si_record_i64($i68);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 986, 19} true;
  assume {:verifier.code 0} true;
  $p69 := $i2p.i64.ref($i68);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 986, 17} true;
  assume {:verifier.code 0} true;
  $p70 := $load.ref($M.0, $p69);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 987, 17} true;
  assume {:verifier.code 0} true;
  $i71 := $p2i.ref.i64($p70);
  // WARNING: %86 = ptrtoint %struct.w1_master* %85 to i64, !dbg !1299, !verifier.code !1093
  call {:cexpr "__cil_tmp55"} boogie_si_record_i64($i71);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 988, 29} true;
  assume {:verifier.code 0} true;
  $i72 := $add.i64($i71, 144);
  // WARNING: %87 = add i64 %86, 144, !dbg !1302, !verifier.code !1093
  call {:cexpr "__cil_tmp56"} boogie_si_record_i64($i72);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 989, 17} true;
  assume {:verifier.code 0} true;
  $p73 := $i2p.i64.ref($i72);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 990, 3} true;
  assume {:verifier.code 0} true;
  call mutex_unlock($p73);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 992, 11} true;
  assume {:verifier.code 0} true;
  $i74 := $trunc.i64.i32($i24);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 992, 3} true;
  assume {:verifier.code 0} true;
  $i15 := $i74;
  goto $bb3;
$bb8:
  assume ($i25 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 922, 5} true;
  assume {:verifier.code 0} true;
  $i24 := 0;
  goto $bb7;
$bb9:
...
$bb10:
  ...
  goto $bb11;
$bb11:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 927, 17} true;
  assume {:verifier.code 0} true;
  $i26 := $sext.i32.i64($i2);
  // WARNING: %34 = sext i32 %2 to i64, !dbg !1164, !verifier.code !1093
  call {:cexpr "__cil_tmp23"} boogie_si_record_i64($i26);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 928, 29} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i64($i26, $i3);
  // WARNING: %35 = add i64 %34, %3, !dbg !1168, !verifier.code !1093
  call {:cexpr "__cil_tmp24"} boogie_si_record_i64($i27);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 929, 19} true;
  assume {:verifier.code 0} true;
  $i28 := $ugt.i64($i27, 64);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 929, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb12, $bb13;
$bb12:
  assume ($i28 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 930, 22} true;
  assume {:verifier.code 0} true;
  $i29 := $sub.i32(64, $i2);
  // WARNING: %38 = sub nsw i32 64, %2, !dbg !1174, !verifier.code !1093
  call {:cexpr "__cil_tmp25"} boogie_si_record_i32($i29);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 931, 13} true;
  assume {:verifier.code 0} true;
  $i30 := $sext.i32.i64($i29);
  // WARNING: %39 = sext i32 %38 to i64, !dbg !1178, !verifier.code !1093
  call {:cexpr "count"} boogie_si_record_i64($i30);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 932, 3} true;
  assume {:verifier.code 0} true;
  $i31 := $i30;
  goto $bb14;
$bb13:
...
$bb14:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 937, 13} true;
  assume {:verifier.code 0} true;
  call $i32 := w1_reset_select_slave($p13);
  // WARNING: %42 = call i32 @w1_reset_select_slave(%struct.w1_slave* %14), !dbg !1180, !verifier.code !1093
  call {:cexpr "tmp___0"} boogie_si_record_i32($i32);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 939, 7} true;
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i32, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 939, 7} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i33 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 941, 3} true;
  assume {:verifier.code 0} true;
  $i34 := $i31;
  goto $bb17;
$bb16:
  assume !(($i33 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 942, 9} true;
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i4, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 942, 7} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i35 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 964, 19} true;
  assume {:verifier.code 0} true;
  $i53 := $p2i.ref.i64($p13);
  // WARNING: %65 = ptrtoint %struct.w1_slave* %14 to i64, !dbg !1241, !verifier.code !1093
  call {:cexpr "__cil_tmp39"} boogie_si_record_i64($i53);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 965, 31} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i64($i53, 88);
  // WARNING: %66 = add i64 %65, 88, !dbg !1246, !verifier.code !1093
  call {:cexpr "__cil_tmp40"} boogie_si_record_i64($i54);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 966, 21} true;
  assume {:verifier.code 0} true;
  $p55 := $i2p.i64.ref($i54);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 966, 19} true;
  assume {:verifier.code 0} true;
  $p56 := $load.ref($M.0, $p55);
  // WARNING: call void @llvm.dbg.value(metadata %struct.w1_master* %68, i64 0, metadata !1629, metadata !1091), !dbg !1630, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 968, 5} true;
  assume {:verifier.code 0} true;
  call w1_write_8($p56, 108);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 969, 19} true;
  assume {:verifier.code 0} true;
  $i57 := $p2i.ref.i64($p13);
  // WARNING: %69 = ptrtoint %struct.w1_slave* %14 to i64, !dbg !1256, !verifier.code !1093
  call {:cexpr "__cil_tmp43"} boogie_si_record_i64($i57);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 970, 31} true;
  assume {:verifier.code 0} true;
  $i58 := $add.i64($i57, 88);
  // WARNING: %70 = add i64 %69, 88, !dbg !1259, !verifier.code !1093
  call {:cexpr "__cil_tmp44"} boogie_si_record_i64($i58);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 971, 21} true;
  assume {:verifier.code 0} true;
  $p59 := $i2p.i64.ref($i58);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 971, 19} true;
  assume {:verifier.code 0} true;
  $p60 := $load.ref($M.0, $p59);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 972, 19} true;
  assume {:verifier.code 0} true;
  $i61 := $trunc.i32.i8($i2);
  // WARNING: %73 = trunc i32 %2 to i8, !dbg !1266, !verifier.code !1093
  call {:cexpr "__cil_tmp46"} boogie_si_record_i8($i61);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 973, 5} true;
  assume {:verifier.code 0} true;
  call w1_write_8($p60, $i61);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 974, 19} true;
  assume {:verifier.code 0} true;
  $i62 := $p2i.ref.i64($p13);
  // WARNING: %74 = ptrtoint %struct.w1_slave* %14 to i64, !dbg !1270, !verifier.code !1093
  call {:cexpr "__cil_tmp47"} boogie_si_record_i64($i62);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 975, 31} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i64($i62, 88);
  // WARNING: %75 = add i64 %74, 88, !dbg !1273, !verifier.code !1093
  call {:cexpr "__cil_tmp48"} boogie_si_record_i64($i63);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 976, 21} true;
  assume {:verifier.code 0} true;
  $p64 := $i2p.i64.ref($i63);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 976, 19} true;
  assume {:verifier.code 0} true;
  $p65 := $load.ref($M.0, $p64);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 978, 19} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i64.i32($i31);
  // WARNING: %78 = trunc i64 %.01 to i32, !dbg !1282, !verifier.code !1093
  call {:cexpr "__cil_tmp51"} boogie_si_record_i32($i66);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 979, 5} true;
  assume {:verifier.code 0} true;
  call w1_write_block($p65, $p1, $i66);
  assume {:verifier.code 0} true;
  $i52 := $i31;
  goto $bb20;
$bb19:
  assume !(($i35 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 944, 19} true;
  assume {:verifier.code 0} true;
  $i36 := $p2i.ref.i64($p13);
  // WARNING: %48 = ptrtoint %struct.w1_slave* %14 to i64, !dbg !1192, !verifier.code !1093
  call {:cexpr "__cil_tmp26"} boogie_si_record_i64($i36);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 945, 31} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i64($i36, 88);
  // WARNING: %49 = add i64 %48, 88, !dbg !1197, !verifier.code !1093
  call {:cexpr "__cil_tmp27"} boogie_si_record_i64($i37);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 946, 21} true;
  assume {:verifier.code 0} true;
  $p38 := $i2p.i64.ref($i37);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 946, 19} true;
  assume {:verifier.code 0} true;
  $p39 := $load.ref($M.0, $p38);
  // WARNING: call void @llvm.dbg.value(metadata %struct.w1_master* %51, i64 0, metadata !1580, metadata !1091), !dbg !1581, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 948, 5} true;
  assume {:verifier.code 0} true;
  call w1_write_8($p39, 105);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 949, 19} true;
  assume {:verifier.code 0} true;
  $i40 := $p2i.ref.i64($p13);
  // WARNING: %52 = ptrtoint %struct.w1_slave* %14 to i64, !dbg !1207, !verifier.code !1093
  call {:cexpr "__cil_tmp30"} boogie_si_record_i64($i40);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 950, 31} true;
  assume {:verifier.code 0} true;
  $i41 := $add.i64($i40, 88);
  // WARNING: %53 = add i64 %52, 88, !dbg !1210, !verifier.code !1093
  call {:cexpr "__cil_tmp31"} boogie_si_record_i64($i41);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 951, 21} true;
  assume {:verifier.code 0} true;
  $p42 := $i2p.i64.ref($i41);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 951, 19} true;
  assume {:verifier.code 0} true;
  $p43 := $load.ref($M.0, $p42);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 952, 19} true;
  assume {:verifier.code 0} true;
  $i44 := $trunc.i32.i8($i2);
  // WARNING: %56 = trunc i32 %2 to i8, !dbg !1217, !verifier.code !1093
  call {:cexpr "__cil_tmp33"} boogie_si_record_i8($i44);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 953, 5} true;
  assume {:verifier.code 0} true;
  call w1_write_8($p43, $i44);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 954, 19} true;
  assume {:verifier.code 0} true;
  $i45 := $p2i.ref.i64($p13);
  // WARNING: %57 = ptrtoint %struct.w1_slave* %14 to i64, !dbg !1221, !verifier.code !1093
  call {:cexpr "__cil_tmp34"} boogie_si_record_i64($i45);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 955, 31} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i64($i45, 88);
  // WARNING: %58 = add i64 %57, 88, !dbg !1224, !verifier.code !1093
  call {:cexpr "__cil_tmp35"} boogie_si_record_i64($i46);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 956, 21} true;
  assume {:verifier.code 0} true;
  $p47 := $i2p.i64.ref($i46);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 956, 19} true;
  assume {:verifier.code 0} true;
  $p48 := $load.ref($M.0, $p47);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 958, 19} true;
  assume {:verifier.code 0} true;
  $i49 := $trunc.i64.i32($i31);
  // WARNING: %61 = trunc i64 %.01 to i32, !dbg !1233, !verifier.code !1093
  call {:cexpr "__cil_tmp38"} boogie_si_record_i32($i49);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 959, 11} true;
  assume {:verifier.code 0} true;
  call $i50 := w1_read_block($p48, $p1, $i49);
  // WARNING: %62 = call zeroext i8 @w1_read_block(%struct.w1_master* %60, i8* %1, i32 %61), !dbg !1236, !verifier.code !1093
  call {:cexpr "tmp"} boogie_si_record_i8($i50);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 960, 13} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.i8.i64($i50);
  // WARNING: %63 = zext i8 %62 to i64, !dbg !1239, !verifier.code !1093
  call {:cexpr "count"} boogie_si_record_i64($i51);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 962, 3} true;
  assume {:verifier.code 0} true;
  $i52 := $i51;
  goto $bb20;
$bb20:
...
const w1_read_block: ref;
axiom (w1_read_block == $sub.ref(0, 50012));
procedure  w1_read_block($p0: ref, $p1: ref, $i2: i32)
  returns ($r: i8);
const w1_write_block: ref;
axiom (w1_write_block == $sub.ref(0, 51044));
procedure  w1_write_block($p0: ref, $p1: ref, $i2: i32);
const w1_ds2760_store_eeprom: ref;
axiom (w1_ds2760_store_eeprom == $sub.ref(0, 52076));
procedure  w1_ds2760_store_eeprom($p0: ref, $i1: i32)
  returns ($r: i32)
{
  var $i2: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata %struct.device* %0, i64 0, metadata !1691, metadata !1091), !dbg !1692, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1105, 9} true;
  assume {:verifier.code 0} true;
  call $i2 := w1_ds2760_eeprom_cmd($p0, $i1, 72);
  // WARNING: %3 = call i32 @w1_ds2760_eeprom_cmd(%struct.device* %0, i32 %1, i32 72), !dbg !1096, !verifier.code !1093
  call {:cexpr "tmp"} boogie_si_record_i32($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1107, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
}
const w1_ds2760_write: ref;
axiom (w1_ds2760_write == $sub.ref(0, 53108));
procedure  w1_ds2760_write($p0: ref, $p1: ref, $i2: i32, $i3: i64)
  returns ($r: i32)
{
  var $i4: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i8* %1, i64 0, metadata !1704, metadata !1091), !dbg !1705, !verifier.code !1093
  // WARNING: call void @llvm.dbg.value(metadata i32 %2, i64 0, metadata !1706, metadata !1091), !dbg !1707, !verifier.code !1093
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1010, 9} true;
  assume {:verifier.code 0} true;
  call $i4 := w1_ds2760_io($p0, $p1, $i2, $i3, 1);
  // WARNING: %5 = call i32 @w1_ds2760_io(%struct.device* %0, i8* %1, i32 %2, i64 %3, i32 1), !dbg !1100, !verifier.code !1093
  call {:cexpr "tmp"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1012, 3} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
}
const w1_ds2760_init: ref;
axiom (w1_ds2760_init == $sub.ref(0, 54140));
procedure  w1_ds2760_init()
  returns ($r: i32)
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1297, 3} true;
  assume {:verifier.code 0} true;
  call $i0 := printk.ref(.str);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1298, 3} true;
  assume {:verifier.code 0} true;
  call ida_init(bat_ida);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1299, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := w1_register_family(w1_ds2760_family);
  // WARNING: %2 = call i32 @w1_register_family(%struct.w1_family* @w1_ds2760_family), !dbg !1093, !verifier.code !1091
  call {:cexpr "tmp"} boogie_si_record_i32($i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1301, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
const printk: ref;
axiom (printk == $sub.ref(0, 55172));
procedure  printk.ref($p0: ref)
  returns ($r: i32);
const ida_init: ref;
axiom (ida_init == $sub.ref(0, 56204));
procedure  ida_init($p0: ref);
const w1_register_family: ref;
axiom (w1_register_family == $sub.ref(0, 57236));
procedure  w1_register_family($p0: ref)
  returns ($r: i32);
const w1_ds2760_exit: ref;
axiom (w1_ds2760_exit == $sub.ref(0, 58268));
procedure  w1_ds2760_exit()
{
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1310, 3} true;
  assume {:verifier.code 0} true;
  call w1_unregister_family(w1_ds2760_family);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1311, 3} true;
  assume {:verifier.code 0} true;
  call ida_destroy(bat_ida);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1313, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const w1_unregister_family: ref;
axiom (w1_unregister_family == $sub.ref(0, 59300));
procedure  w1_unregister_family($p0: ref);
const ida_destroy: ref;
axiom (ida_destroy == $sub.ref(0, 60332));
procedure  ida_destroy($p0: ref);
const main: ref;
axiom (main == $sub.ref(0, 61364));
...
$bb0:
  call $initialize();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1438, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1439, 3} true;
  assume {:verifier.code 0} true;
  call ldv_initialize();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1440, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := w1_ds2760_init();
  // WARNING: %1 = call i32 @w1_ds2760_init(), !dbg !1093, !verifier.code !1091
  call {:cexpr "tmp"} boogie_si_record_i32($i0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1442, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1442, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1443, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  ...
  goto $bb4;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1504, 3} true;
  assume {:verifier.code 0} true;
  call ldv_check_final_state();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1506, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1448, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1448, 13} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1451, 15} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  // WARNING: %8 = call i32 @__VERIFIER_nondet_int(), !dbg !1106, !verifier.code !1109
  call {:cexpr "tmp___1"} boogie_si_record_i32($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1453, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1453, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i3 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1455, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !(($i3 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1456, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1459, 15} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i4);
  // WARNING: %13 = call i32 @__VERIFIER_nondet_int(), !dbg !1119, !verifier.code !1109
  call {:cexpr "tmp___0"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1461, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1461, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb11, $bb12;
$bb10:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1500, 3} true;
  assume {:verifier.code 0} true;
  call w1_ds2760_exit();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1501, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb11:
  assume ($i5 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1462, 7} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !(($i5 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1464, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i4, 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1464, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb14, $bb15;
$bb13:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1475, 9} true;
  assume {:verifier.code 0} true;
  call $i8 := w1_ds2760_read_bin($u0, $u1, $u2, $u3, $u4, $u4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1478, 9} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb14:
  assume ($i6 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1465, 7} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb15:
  assume !(($i6 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1467, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i4, 2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1467, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb17, $bb18;
$bb16:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1481, 9} true;
  assume {:verifier.code 0} true;
  call $i9 := w1_ds2760_add_slave($u5);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1483, 9} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb17:
  assume ($i7 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1468, 7} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume !(($i7 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1471, 7} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb19:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1486, 9} true;
  assume {:verifier.code 0} true;
  call w1_ds2760_remove_slave($u5);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1488, 9} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb20:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1490, 9} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb21:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1472, 11} true;
  assume {:verifier.code 0} true;
...
axiom (ldv_initialize == $sub.ref(0, 62396));
procedure  ldv_initialize();
const ldv_check_final_state: ref;
axiom (ldv_check_final_state == $sub.ref(0, 63428));
procedure  ldv_check_final_state()
{
  var $i0: i32;
  var $i1: i1;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1641, 7} true;
  assume {:verifier.code 0} true;
  $i0 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1641, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1641, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1643, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1645, 5} true;
  assume {:verifier.code 0} true;
  call ldv_blast_assert();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--w1--slaves--w1_ds2760.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-uEelgB.c", 1648, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 64460));
procedure  __VERIFIER_assume($i0: i32)
{
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !1819, metadata !1091), !dbg !1820, !verifier.code !1093
...
axiom (__SMACK_code == $sub.ref(0, 65492));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 66524));
...
axiom (__VERIFIER_error == $sub.ref(0, 67556));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 68588));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 69620));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 70652));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 71684));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 72716));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 73748));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 74780));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 75812));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 76844));
...
$bb0:
  ...
  // WARNING: %1 = call i32 @__SMACK_nondet_int(), !dbg !1088, !verifier.code !1089
...
axiom (__SMACK_nondet_int == $sub.ref(0, 77876));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 78908));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 79940));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 80972));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 82004));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 83036));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 84068));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 85100));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 86132));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 87164));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 88196));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 89228));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 90260));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 91292));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 92324));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 93356));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 94388));
...
axiom (__SMACK_top_decl == $sub.ref(0, 95420));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 96452));
...
axiom (llvm.dbg.value == $sub.ref(0, 97484));
procedure  llvm.dbg.value($p0: ref, $i1: i64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 98516));
...
$bb0:
  ...
  $M.1 := 1;
  call {:cexpr "ldv_mutex"} boogie_si_record_i32(1);
  $M.0 := $store.ref($M.0, llvm.used, __kcrctab_w1_ds2760_read);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 8), __ksymtab_w1_ds2760_read);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 16), __kcrctab_w1_ds2760_write);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 24), __ksymtab_w1_ds2760_write);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 32), __kcrctab_w1_ds2760_store_eeprom);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 40), __ksymtab_w1_ds2760_store_eeprom);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 48), __kcrctab_w1_ds2760_recall_eeprom);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 56), __ksymtab_w1_ds2760_recall_eeprom);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 64), __mod_license203);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 72), __mod_author204);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 80), __mod_description205);
  $M.0 := $store.i64($M.0, __kcrctab_w1_ds2760_read, $p2i.ref.i64(__crc_w1_ds2760_read));
  call {:cexpr "__kcrctab_w1_ds2760_read"} boogie_si_record_i64($p2i.ref.i64(__crc_w1_ds2760_read));
  $M.0 := $store.i64($M.0, __ksymtab_w1_ds2760_read, $p2i.ref.i64(w1_ds2760_read));
  $M.0 := $store.ref($M.0, $add.ref(__ksymtab_w1_ds2760_read, 8), __kstrtab_w1_ds2760_read);
  $M.0 := $store.i64($M.0, __kcrctab_w1_ds2760_write, $p2i.ref.i64(__crc_w1_ds2760_write));
  call {:cexpr "__kcrctab_w1_ds2760_write"} boogie_si_record_i64($p2i.ref.i64(__crc_w1_ds2760_write));
  $M.0 := $store.i64($M.0, __ksymtab_w1_ds2760_write, $p2i.ref.i64(w1_ds2760_write));
  $M.0 := $store.ref($M.0, $add.ref(__ksymtab_w1_ds2760_write, 8), __kstrtab_w1_ds2760_write);
  $M.0 := $store.i64($M.0, __kcrctab_w1_ds2760_store_eeprom, $p2i.ref.i64(__crc_w1_ds2760_store_eeprom));
  call {:cexpr "__kcrctab_w1_ds2760_store_eeprom"} boogie_si_record_i64($p2i.ref.i64(__crc_w1_ds2760_store_eeprom));
  $M.0 := $store.i64($M.0, __ksymtab_w1_ds2760_store_eeprom, $p2i.ref.i64(w1_ds2760_store_eeprom));
  $M.0 := $store.ref($M.0, $add.ref(__ksymtab_w1_ds2760_store_eeprom, 8), __kstrtab_w1_ds2760_store_eeprom);
  $M.0 := $store.i64($M.0, __kcrctab_w1_ds2760_recall_eeprom, $p2i.ref.i64(__crc_w1_ds2760_recall_eeprom));
  call {:cexpr "__kcrctab_w1_ds2760_recall_eeprom"} boogie_si_record_i64($p2i.ref.i64(__crc_w1_ds2760_recall_eeprom));
  $M.0 := $store.i64($M.0, __ksymtab_w1_ds2760_recall_eeprom, $p2i.ref.i64(w1_ds2760_recall_eeprom));
  $M.0 := $store.ref($M.0, $add.ref(__ksymtab_w1_ds2760_recall_eeprom, 8), __kstrtab_w1_ds2760_recall_eeprom);
  $M.0 := $store.i8($M.0, __mod_license203, 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 1), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 2), 99);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 3), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 4), 110);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 5), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 6), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 7), 61);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 8), 71);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 9), 80);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 10), 76);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license203, 11), 0);
  $M.0 := $store.i8($M.0, __mod_author204, 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 1), 117);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 2), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 3), 104);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 4), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 5), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 6), 61);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 7), 83);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 8), 122);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 9), 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 10), 98);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 11), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 12), 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 13), 99);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 14), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 15), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 16), 71);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 17), 121);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 18), 117);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 19), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 20), 107);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 21), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 22), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 23), 60);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 24), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 25), 122);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 26), 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 27), 98);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 28), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 29), 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 30), 99);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 31), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 32), 46);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 33), 103);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 34), 121);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 35), 117);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 36), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 37), 107);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 38), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 39), 64);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 40), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 41), 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 42), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 43), 46);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 44), 104);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 45), 117);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 46), 62);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author204, 47), 0);
  $M.0 := $store.i8($M.0, __mod_description205, 100);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 1), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 2), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 3), 99);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 4), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 5), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 6), 112);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 7), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 8), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 9), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 10), 110);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 11), 61);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 12), 49);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 13), 45);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 14), 119);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 15), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 16), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 17), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 18), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 19), 68);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 20), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 21), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 22), 118);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 23), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 24), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 25), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 26), 68);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 27), 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 28), 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 29), 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 30), 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 31), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 32), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 33), 50);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 34), 55);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 35), 54);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 36), 48);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 37), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 38), 98);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 39), 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 40), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 41), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 42), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 43), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 44), 121);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 45), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 46), 109);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 47), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 48), 110);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 49), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 50), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 51), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 52), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 53), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 54), 99);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 55), 104);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 56), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 57), 112);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description205, 58), 0);
  $M.0 := $store.i8($M.0, __kstrtab_w1_ds2760_recall_eeprom, 119);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 1), 49);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 2), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 3), 100);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 4), 115);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 5), 50);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 6), 55);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 7), 54);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 8), 48);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 9), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 10), 114);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 11), 101);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 12), 99);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 13), 97);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 14), 108);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 15), 108);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 16), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 17), 101);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 18), 101);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 19), 112);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 20), 114);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 21), 111);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 22), 109);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_recall_eeprom, 23), 0);
  $M.0 := $store.ref($M.0, w1_ds2760_bin_attr, .str.2);
  $M.0 := $store.i16($M.0, $add.ref(w1_ds2760_bin_attr, 8), 292);
  $M.0 := $store.i64($M.0, $add.ref(w1_ds2760_bin_attr, 16), 64);
  $M.0 := $store.ref($M.0, $add.ref(w1_ds2760_bin_attr, 24), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(w1_ds2760_bin_attr, 32), w1_ds2760_read_bin);
  $M.0 := $store.ref($M.0, $add.ref(w1_ds2760_bin_attr, 40), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(w1_ds2760_bin_attr, 48), $0.ref);
  $M.0 := $store.ref($M.0, w1_ds2760_fops, w1_ds2760_add_slave);
  $M.0 := $store.ref($M.0, $add.ref(w1_ds2760_fops, 8), w1_ds2760_remove_slave);
  $M.0 := $store.ref($M.0, w1_ds2760_family, $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(w1_ds2760_family, 8), $0.ref);
  $M.0 := $store.i8($M.0, $add.ref(w1_ds2760_family, 16), 48);
  $M.0 := $store.ref($M.0, $add.ref(w1_ds2760_family, 24), w1_ds2760_fops);
  $M.0 := $store.i32($M.0, $add.ref(w1_ds2760_family, 32), 0);
  $M.0 := $store.ref($M.0, bat_ida, $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(bat_ida, 8), $0.ref);
  $M.0 := $store.i32($M.0, $add.ref(bat_ida, 16), 0);
  $M.0 := $store.i32($M.0, $add.ref(bat_ida, 20), 0);
  $M.0 := $store.i32($M.0, $add.ref(bat_ida, 24), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(bat_ida, 24), 4), $sub.i32(0, 559067475));
  $M.0 := $store.i32($M.0, $add.ref($add.ref(bat_ida, 24), 8), $sub.i32(0, 1));
  $M.0 := $store.ref($M.0, $add.ref($add.ref(bat_ida, 24), 16), $i2p.i64.ref($sub.i64(0, 1)));
  $M.0 := $store.ref($M.0, $add.ref(bat_ida, 48), $0.ref);
  $M.0 := $store.i8($M.0, __kstrtab_w1_ds2760_store_eeprom, 119);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 1), 49);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 2), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 3), 100);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 4), 115);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 5), 50);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 6), 55);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 7), 54);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 8), 48);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 9), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 10), 115);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 11), 116);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 12), 111);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 13), 114);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 14), 101);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 15), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 16), 101);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 17), 101);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 18), 112);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 19), 114);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 20), 111);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 21), 109);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_store_eeprom, 22), 0);
  $M.0 := $store.i8($M.0, __kstrtab_w1_ds2760_write, 119);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 1), 49);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 2), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 3), 100);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 4), 115);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 5), 50);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 6), 55);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 7), 54);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 8), 48);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 9), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 10), 119);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 11), 114);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 12), 105);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 13), 116);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 14), 101);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_write, 15), 0);
  $M.0 := $store.i8($M.0, __kstrtab_w1_ds2760_read, 119);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 1), 49);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 2), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 3), 100);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 4), 115);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 5), 50);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 6), 55);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 7), 54);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 8), 48);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 9), 95);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 10), 114);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 11), 101);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 12), 97);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 13), 100);
  $M.0 := $store.i8($M.0, $add.ref(__kstrtab_w1_ds2760_read, 14), 0);
  $exn := false;
  return;
}
const $u0: ref;
