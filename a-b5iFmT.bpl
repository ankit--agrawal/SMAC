...
// via /mnt/local/smack-project/smack/bin/smack -x=svcomp --time-limit 1800 /proj/SMACK/sv-benchmarks/c/ldv-linux-3.4-simple/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c --verifier-options  /bopt:z3opt:SMT.MBQI=true /bopt:z3opt:SMT.MBQI.MAX_ITERATIONS=1000 /di /staticInlining /trackAllVars /useArrayTheory --unroll 16
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 77206));
...
const {:count 59} __mod_description34: ref;
axiom (__mod_description34 == $sub.ref(0, 4187));
const {:count 25} __mod_author35: ref;
axiom (__mod_author35 == $sub.ref(0, 5236));
const {:count 12} __mod_license36: ref;
axiom (__mod_license36 == $sub.ref(0, 6272));
const {:count 3} icplus_tbl: ref;
axiom (icplus_tbl == $sub.ref(0, 7320));
const full_reset_performed: ref;
axiom (full_reset_performed == $sub.ref(0, 8348));
const ip175c_driver: ref;
axiom (ip175c_driver == $sub.ref(0, 9620));
const ip101a_g_driver: ref;
axiom (ip101a_g_driver == $sub.ref(0, 10892));
const ip1001_driver: ref;
axiom (ip1001_driver == $sub.ref(0, 12164));
const .str: ref;
axiom (.str == $sub.ref(0, 13202));
const __this_module: ref;
axiom (__this_module == $sub.ref(0, 32776));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 14242));
const {:count 14} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 15280));
const {:count 14} .str.2.8: ref;
axiom (.str.2.8 == $sub.ref(0, 16318));
const icplus_init: ref;
axiom (icplus_init == $sub.ref(0, 17350));
procedure  icplus_init()
  returns ($r: i32)
{
  var $i0: i32;
  var $i1: i1;
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5024, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := phy_driver_register(ip1001_driver);
  // WARNING: %1 = call i32 @phy_driver_register(%struct.phy_driver* @ip1001_driver), !dbg !5586, !verifier.code !5585
  call {:cexpr "ret"} boogie_si_record_i32($i0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5026, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5026, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5027, 5} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, 19);
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5044, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5032, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := phy_driver_register(ip101a_g_driver);
  // WARNING: %6 = call i32 @phy_driver_register(%struct.phy_driver* @ip101a_g_driver), !dbg !5594, !verifier.code !5585
  call {:cexpr "ret"} boogie_si_record_i32($i3);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5034, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5034, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i4 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5035, 5} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, 19);
  goto $bb3;
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5040, 13} true;
  assume {:verifier.code 0} true;
  call $i5 := phy_driver_register(ip175c_driver);
  // WARNING: %11 = call i32 @phy_driver_register(%struct.phy_driver* @ip175c_driver), !dbg !5601, !verifier.code !5585
  call {:cexpr "tmp___7"} boogie_si_record_i32($i5);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5042, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $i5;
  goto $bb3;
}
const phy_driver_register: ref;
axiom (phy_driver_register == $sub.ref(0, 18382));
procedure  phy_driver_register($p0: ref)
  returns ($r: i32);
const ip1001_config_init: ref;
axiom (ip1001_config_init == $sub.ref(0, 19414));
procedure  ip1001_config_init($p0: ref)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4792, 7} true;
  assume {:verifier.code 0} true;
  call $i1 := ip1xx_reset($p0);
  // WARNING: %2 = call i32 @ip1xx_reset(%struct.phy_device* %0), !dbg !5586, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4794, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4794, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4795, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i1;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4851, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4801, 7} true;
  assume {:verifier.code 0} true;
  call $i4 := phy_read($p0, 20);
  // WARNING: %7 = call i32 @phy_read(%struct.phy_device* %0, i32 20), !dbg !5598, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4803, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4803, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4804, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4809, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $or.i32($i4, 11);
  // WARNING: %12 = or i32 %7, 11, !dbg !5605, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i6);
  // WARNING: call void @llvm.dbg.value(metadata i32 %12, i64 0, metadata !5613, metadata !5583), !dbg !5614, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4811, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i32.i16($i6);
  // WARNING: %13 = trunc i32 %12 to i16, !dbg !5609, !verifier.code !5585
  call {:cexpr "__cil_tmp5"} boogie_si_record_i16($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4812, 7} true;
  assume {:verifier.code 0} true;
  call $i8 := phy_write($p0, 20, $i7);
  // WARNING: %14 = call i32 @phy_write(%struct.phy_device* %0, i32 20, i16 zeroext %13), !dbg !5612, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4814, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.i32($i8, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4814, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i9 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4815, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i8;
  goto $bb3;
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4820, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $p2i.ref.i64($p0);
  // WARNING: %19 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5618, !verifier.code !5585
  call {:cexpr "__cil_tmp6"} boogie_si_record_i64($i10);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4821, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i64($i10, 796);
  // WARNING: %20 = add i64 %19, 796, !dbg !5622, !verifier.code !5585
  call {:cexpr "__cil_tmp7"} boogie_si_record_i64($i11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4822, 18} true;
  assume {:verifier.code 0} true;
  $p12 := $i2p.i64.ref($i11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4822, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.0, $p12);
  // WARNING: %22 = load i32, i32* %21, align 4, !dbg !5626, !verifier.code !5585
  call {:cexpr "__cil_tmp8"} boogie_si_record_i32($i13);
  // WARNING: call void @llvm.dbg.value(metadata i32 %22, i64 0, metadata !5651, metadata !5583), !dbg !5652, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4824, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i32($i13, 6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4824, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb11, $bb12;
$bb11:
  assume ($i14 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4827, 9} true;
  assume {:verifier.code 0} true;
  call $i15 := phy_read($p0, 16);
  // WARNING: %25 = call i32 @phy_read(%struct.phy_device* %0, i32 16), !dbg !5636, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i15);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4829, 11} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.i32($i15, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4829, 9} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4830, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $i15;
  goto $bb3;
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4835, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $or.i32($i15, 3);
  // WARNING: %30 = or i32 %25, 3, !dbg !5644, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i17);
  // WARNING: call void @llvm.dbg.value(metadata i32 %30, i64 0, metadata !5613, metadata !5583), !dbg !5614, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4837, 19} true;
  assume {:verifier.code 0} true;
  $i18 := $trunc.i32.i16($i17);
  // WARNING: %31 = trunc i32 %30 to i16, !dbg !5648, !verifier.code !5585
  call {:cexpr "__cil_tmp12"} boogie_si_record_i16($i18);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4838, 9} true;
  assume {:verifier.code 0} true;
  call $i19 := phy_write($p0, 16, $i18);
  // WARNING: %32 = call i32 @phy_write(%struct.phy_device* %0, i32 16, i16 zeroext %31), !dbg !5651, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i19);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4840, 11} true;
  assume {:verifier.code 0} true;
  $i20 := $slt.i32($i19, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4840, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i20 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4841, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $i19;
  goto $bb3;
$bb17:
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4845, 3} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb19:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4849, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
}
const genphy_suspend: ref;
axiom (genphy_suspend == $sub.ref(0, 20446));
procedure  genphy_suspend($p0: ref)
  returns ($r: i32);
const genphy_resume: ref;
axiom (genphy_resume == $sub.ref(0, 21478));
procedure  genphy_resume($p0: ref)
  returns ($r: i32);
const genphy_config_aneg: ref;
axiom (genphy_config_aneg == $sub.ref(0, 22510));
procedure  genphy_config_aneg($p0: ref)
  returns ($r: i32);
const genphy_read_status: ref;
axiom (genphy_read_status == $sub.ref(0, 23542));
procedure  genphy_read_status($p0: ref)
  returns ($r: i32);
const ip1xx_reset: ref;
axiom (ip1xx_reset == $sub.ref(0, 24574));
procedure  ip1xx_reset($p0: ref)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i3: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata %struct.phy_device* %0, i64 0, metadata !5685, metadata !5583), !dbg !5686, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4736, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := phy_read($p0, 0);
  // WARNING: %2 = call i32 @phy_read(%struct.phy_device* %0, i32 0), !dbg !5588, !verifier.code !5585
  call {:cexpr "bmcr"} boogie_si_record_i32($i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4738, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4738, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4739, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i1;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4776, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4744, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $or.i32($i1, 32768);
  // WARNING: %7 = or i32 %2, 32768, !dbg !5598, !verifier.code !5585
  call {:cexpr "bmcr"} boogie_si_record_i32($i4);
  // WARNING: call void @llvm.dbg.value(metadata i32 %7, i64 0, metadata !5692, metadata !5583), !dbg !5693, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4746, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $trunc.i32.i16($i4);
  // WARNING: %8 = trunc i32 %7 to i16, !dbg !5602, !verifier.code !5585
  call {:cexpr "__cil_tmp5"} boogie_si_record_i16($i5);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4747, 10} true;
  assume {:verifier.code 0} true;
  call $i6 := phy_write($p0, 0, $i5);
  // WARNING: %9 = call i32 @phy_write(%struct.phy_device* %0, i32 0, i16 zeroext %8), !dbg !5605, !verifier.code !5585
  call {:cexpr "bmcr"} boogie_si_record_i32($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4749, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.i32($i6, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4749, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i7 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4750, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i6;
  goto $bb3;
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4755, 3} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4755, 13} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4759, 12} true;
  assume {:verifier.code 0} true;
  call $i8 := phy_read($p0, 0);
  // WARNING: %16 = call i32 @phy_read(%struct.phy_device* %0, i32 0), !dbg !5617, !verifier.code !5585
  call {:cexpr "bmcr"} boogie_si_record_i32($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4761, 14} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.i32($i8, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4761, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $i8;
  assume {:branchcond $i9} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i9 == 1);
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4762, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $i10;
  goto $bb3;
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4766, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $and.i32($i8, 32768);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4766, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4766, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb13, $bb14;
$bb13:
  assume ($i12 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4768, 5} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume !(($i12 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4769, 7} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb15:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4755, 3} true;
  ...
  goto $bb8;
$bb16:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4774, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
}
const phy_read: ref;
axiom (phy_read == $sub.ref(0, 25606));
  ...
  returns ($r: i32)
{
  ...
  var $i10: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata %struct.phy_device* %0, i64 0, metadata !5741, metadata !5583), !dbg !5742, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4477, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $p2i.ref.i64($p0);
  // WARNING: %3 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5590, !verifier.code !5587
  call {:cexpr "__cil_tmp4"} boogie_si_record_i64($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4478, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i64($i2, 8);
  // WARNING: %4 = add i64 %3, 8, !dbg !5595, !verifier.code !5587
  call {:cexpr "__cil_tmp5"} boogie_si_record_i64($i3);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4479, 18} true;
  assume {:verifier.code 0} true;
  $p4 := $i2p.i64.ref($i3);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4479, 16} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.0, $p4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4480, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $p2i.ref.i64($p0);
  // WARNING: %7 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5602, !verifier.code !5587
  call {:cexpr "__cil_tmp7"} boogie_si_record_i64($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4481, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i64($i6, 800);
  // WARNING: %8 = add i64 %7, 800, !dbg !5605, !verifier.code !5587
  call {:cexpr "__cil_tmp8"} boogie_si_record_i64($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4482, 18} true;
  assume {:verifier.code 0} true;
  $p8 := $i2p.i64.ref($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4482, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p8);
  // WARNING: %10 = load i32, i32* %9, align 4, !dbg !5609, !verifier.code !5587
  call {:cexpr "__cil_tmp9"} boogie_si_record_i32($i9);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4483, 13} true;
  assume {:verifier.code 0} true;
  call $i10 := mdiobus_read($p5, $i9, $i1);
  // WARNING: %11 = call i32 @mdiobus_read(%struct.mii_bus* %6, i32 %10, i32 %1), !dbg !5612, !verifier.code !5587
  call {:cexpr "tmp___7"} boogie_si_record_i32($i10);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4485, 3} true;
  assume {:verifier.code 0} true;
  $r := $i10;
  $exn := false;
  return;
...
const phy_write: ref;
axiom (phy_write == $sub.ref(0, 26638));
  ...
  returns ($r: i32)
{
  ...
  var $i11: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata %struct.phy_device* %0, i64 0, metadata !5774, metadata !5583), !dbg !5775, !verifier.code !5585
  // WARNING: call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !5776, metadata !5583), !dbg !5777, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4500, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $p2i.ref.i64($p0);
  // WARNING: %4 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5592, !verifier.code !5587
  call {:cexpr "__cil_tmp5"} boogie_si_record_i64($i3);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4501, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i64($i3, 8);
  // WARNING: %5 = add i64 %4, 8, !dbg !5597, !verifier.code !5587
  call {:cexpr "__cil_tmp6"} boogie_si_record_i64($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4502, 18} true;
  assume {:verifier.code 0} true;
  $p5 := $i2p.i64.ref($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4502, 16} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.0, $p5);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4503, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $p2i.ref.i64($p0);
  // WARNING: %8 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5604, !verifier.code !5587
  call {:cexpr "__cil_tmp8"} boogie_si_record_i64($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4504, 27} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i64($i7, 800);
  // WARNING: %9 = add i64 %8, 800, !dbg !5607, !verifier.code !5587
  call {:cexpr "__cil_tmp9"} boogie_si_record_i64($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4505, 19} true;
  assume {:verifier.code 0} true;
  $p9 := $i2p.i64.ref($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4505, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p9);
  // WARNING: %11 = load i32, i32* %10, align 4, !dbg !5611, !verifier.code !5587
  call {:cexpr "__cil_tmp10"} boogie_si_record_i32($i10);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4506, 13} true;
  assume {:verifier.code 0} true;
  call $i11 := mdiobus_write($p6, $i10, $i1, $i2);
  // WARNING: %12 = call i32 @mdiobus_write(%struct.mii_bus* %7, i32 %11, i32 %1, i16 zeroext %2), !dbg !5614, !verifier.code !5587
  call {:cexpr "tmp___7"} boogie_si_record_i32($i11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4508, 3} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $exn := false;
  return;
...
axiom (mdiobus_write == $sub.ref(0, 27670));
procedure  mdiobus_write($p0: ref, $i1: i32, $i2: i32, $i3: i16)
  returns ($r: i32);
const mdiobus_read: ref;
axiom (mdiobus_read == $sub.ref(0, 28702));
procedure  mdiobus_read($p0: ref, $i1: i32, $i2: i32)
  returns ($r: i32);
const ip101a_g_config_init: ref;
axiom (ip101a_g_config_init == $sub.ref(0, 29734));
procedure  ip101a_g_config_init($p0: ref)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4861, 7} true;
  assume {:verifier.code 0} true;
  call $i1 := ip1xx_reset($p0);
  // WARNING: %2 = call i32 @ip1xx_reset(%struct.phy_device* %0), !dbg !5586, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4863, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4863, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4864, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i1;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4878, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4870, 7} true;
  assume {:verifier.code 0} true;
  call $i4 := phy_read($p0, 16);
  // WARNING: %7 = call i32 @phy_read(%struct.phy_device* %0, i32 16), !dbg !5598, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4871, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $or.i32($i4, 2);
  // WARNING: %8 = or i32 %7, 2, !dbg !5600, !verifier.code !5585
  call {:cexpr "c"} boogie_si_record_i32($i5);
  // WARNING: call void @llvm.dbg.value(metadata i32 %8, i64 0, metadata !5812, metadata !5583), !dbg !5813, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4873, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i32.i16($i5);
  // WARNING: %9 = trunc i32 %8 to i16, !dbg !5603, !verifier.code !5585
  call {:cexpr "__cil_tmp6"} boogie_si_record_i16($i6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4874, 13} true;
  assume {:verifier.code 0} true;
  call $i7 := phy_write($p0, 16, $i6);
  // WARNING: %10 = call i32 @phy_write(%struct.phy_device* %0, i32 16, i16 zeroext %9), !dbg !5606, !verifier.code !5585
  call {:cexpr "tmp___7"} boogie_si_record_i32($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4876, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i7;
  goto $bb3;
}
const ip101a_g_ack_interrupt: ref;
axiom (ip101a_g_ack_interrupt == $sub.ref(0, 30766));
procedure  ip101a_g_ack_interrupt($p0: ref)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i1;
  var $i3: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata %struct.phy_device* %0, i64 0, metadata !5835, metadata !5583), !dbg !5836, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4933, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := phy_read($p0, 17);
  // WARNING: %2 = call i32 @phy_read(%struct.phy_device* %0, i32 17), !dbg !5588, !verifier.code !5585
  call {:cexpr "tmp___7"} boogie_si_record_i32($i1);
  // WARNING: call void @llvm.dbg.value(metadata i32 %2, i64 0, metadata !5842, metadata !5583), !dbg !5843, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4936, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4936, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4937, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i1;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4943, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4941, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
}
const ip175c_config_init: ref;
axiom (ip175c_config_init == $sub.ref(0, 31798));
procedure  ip175c_config_init($p0: ref)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i1;
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4597, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4597, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4597, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4599, 18} true;
  assume {:verifier.code 0} true;
  $i3 := $p2i.ref.i64($p0);
  // WARNING: %5 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5591, !verifier.code !5585
  call {:cexpr "__cil_tmp8"} boogie_si_record_i64($i3);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4600, 29} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i64($i3, 8);
  // WARNING: %6 = add i64 %5, 8, !dbg !5596, !verifier.code !5585
  call {:cexpr "__cil_tmp9"} boogie_si_record_i64($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4601, 21} true;
  assume {:verifier.code 0} true;
  $p5 := $i2p.i64.ref($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4601, 19} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.0, $p5);
  // WARNING: call void @llvm.dbg.value(metadata %struct.mii_bus* %8, i64 0, metadata !5871, metadata !5583), !dbg !5872, !verifier.code !5585
  // WARNING: call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !5873, metadata !5583), !dbg !5874, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4604, 11} true;
  assume {:verifier.code 0} true;
  call $i7 := mdiobus_write($p6, 30, 0, 5980);
  // WARNING: %9 = call i32 @mdiobus_write(%struct.mii_bus* %8, i32 30, i32 0, i16 zeroext 5980), !dbg !5607, !verifier.code !5585
  call {:cexpr "err"} boogie_si_record_i32($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4606, 13} true;
  assume {:verifier.code 0} true;
  $i8 := $slt.i32($i7, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4606, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i8 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4607, 7} true;
  assume {:verifier.code 0} true;
  $i9 := $i7;
  goto $bb5;
$bb4:
...
$bb5:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4725, 1} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4612, 19} true;
  assume {:verifier.code 0} true;
  $i10 := $p2i.ref.i64($p0);
  // WARNING: %14 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5615, !verifier.code !5585
  call {:cexpr "__cil_tmp13"} boogie_si_record_i64($i10);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4613, 31} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i64($i10, 8);
  // WARNING: %15 = add i64 %14, 8, !dbg !5619, !verifier.code !5585
  call {:cexpr "__cil_tmp14"} boogie_si_record_i64($i11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4614, 21} true;
  assume {:verifier.code 0} true;
  $p12 := $i2p.i64.ref($i11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4614, 19} true;
  assume {:verifier.code 0} true;
  $p13 := $load.ref($M.0, $p12);
  // WARNING: call void @llvm.dbg.value(metadata %struct.mii_bus* %17, i64 0, metadata !5894, metadata !5583), !dbg !5895, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4616, 11} true;
  assume {:verifier.code 0} true;
  call $i14 := mdiobus_read($p13, 30, 0);
  // WARNING: %18 = call i32 @mdiobus_read(%struct.mii_bus* %17, i32 30, i32 0), !dbg !5628, !verifier.code !5585
  call {:cexpr "err"} boogie_si_record_i32($i14);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4617, 5} true;
  assume {:verifier.code 0} true;
  call __const_udelay(8590000);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4618, 19} true;
  assume {:verifier.code 0} true;
  $i15 := $p2i.ref.i64($p0);
  // WARNING: %19 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5630, !verifier.code !5585
  call {:cexpr "__cil_tmp17"} boogie_si_record_i64($i15);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4619, 31} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i64($i15, 8);
  // WARNING: %20 = add i64 %19, 8, !dbg !5633, !verifier.code !5585
  call {:cexpr "__cil_tmp18"} boogie_si_record_i64($i16);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4620, 21} true;
  assume {:verifier.code 0} true;
  $p17 := $i2p.i64.ref($i16);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4620, 19} true;
  assume {:verifier.code 0} true;
  $p18 := $load.ref($M.0, $p17);
  // WARNING: call void @llvm.dbg.value(metadata %struct.mii_bus* %22, i64 0, metadata !5908, metadata !5583), !dbg !5909, !verifier.code !5585
  // WARNING: call void @llvm.dbg.value(metadata i32 31, i64 0, metadata !5910, metadata !5583), !dbg !5911, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4623, 11} true;
  assume {:verifier.code 0} true;
  call $i19 := mdiobus_write($p18, 29, 31, 5980);
  // WARNING: %23 = call i32 @mdiobus_write(%struct.mii_bus* %22, i32 29, i32 31, i16 zeroext 5980), !dbg !5644, !verifier.code !5585
  call {:cexpr "err"} boogie_si_record_i32($i19);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4625, 13} true;
  assume {:verifier.code 0} true;
  $i20 := $slt.i32($i19, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4625, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb7, $bb8;
$bb7:
  assume ($i20 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4626, 7} true;
  assume {:verifier.code 0} true;
  $i9 := $i19;
  goto $bb5;
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4631, 19} true;
  assume {:verifier.code 0} true;
  $i21 := $p2i.ref.i64($p0);
  // WARNING: %28 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5650, !verifier.code !5585
  call {:cexpr "__cil_tmp22"} boogie_si_record_i64($i21);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4632, 31} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i64($i21, 8);
  // WARNING: %29 = add i64 %28, 8, !dbg !5654, !verifier.code !5585
  call {:cexpr "__cil_tmp23"} boogie_si_record_i64($i22);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4633, 21} true;
  assume {:verifier.code 0} true;
  $p23 := $i2p.i64.ref($i22);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4633, 19} true;
  assume {:verifier.code 0} true;
  $p24 := $load.ref($M.0, $p23);
  // WARNING: call void @llvm.dbg.value(metadata %struct.mii_bus* %31, i64 0, metadata !5929, metadata !5583), !dbg !5930, !verifier.code !5585
  // WARNING: call void @llvm.dbg.value(metadata i32 22, i64 0, metadata !5931, metadata !5583), !dbg !5932, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4636, 11} true;
  assume {:verifier.code 0} true;
  call $i25 := mdiobus_write($p24, 29, 22, 1056);
  // WARNING: %32 = call i32 @mdiobus_write(%struct.mii_bus* %31, i32 29, i32 22, i16 zeroext 1056), !dbg !5665, !verifier.code !5585
  call {:cexpr "err"} boogie_si_record_i32($i25);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4638, 13} true;
  assume {:verifier.code 0} true;
  $i26 := $slt.i32($i25, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4638, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i26 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4639, 7} true;
  assume {:verifier.code 0} true;
  $i9 := $i25;
  goto $bb5;
$bb11:
  ...
  goto $bb12;
$bb12:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4645, 5} true;
  assume {:verifier.code 0} true;
  $i27 := 0;
  goto $bb13;
$bb13:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4645, 15} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4647, 13} true;
  assume {:verifier.code 0} true;
  $i28 := $slt.i32($i27, 5);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4647, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i28 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4649, 7} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i28 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4650, 9} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb17:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4653, 21} true;
  assume {:verifier.code 0} true;
  $i29 := $p2i.ref.i64($p0);
  // WARNING: %43 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5685, !verifier.code !5585
  call {:cexpr "__cil_tmp27"} boogie_si_record_i64($i29);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4654, 33} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i64($i29, 8);
  // WARNING: %44 = add i64 %43, 8, !dbg !5689, !verifier.code !5585
  call {:cexpr "__cil_tmp28"} boogie_si_record_i64($i30);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4655, 23} true;
  assume {:verifier.code 0} true;
  $p31 := $i2p.i64.ref($i30);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4655, 21} true;
  assume {:verifier.code 0} true;
  $p32 := $load.ref($M.0, $p31);
  // WARNING: call void @llvm.dbg.value(metadata %struct.mii_bus* %46, i64 0, metadata !5964, metadata !5583), !dbg !5965, !verifier.code !5585
  // WARNING: call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !5966, metadata !5583), !dbg !5967, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4658, 13} true;
  assume {:verifier.code 0} true;
  call $i33 := mdiobus_write($p32, $i27, 0, $sub.i16(0, 32768));
  // WARNING: %47 = call i32 @mdiobus_write(%struct.mii_bus* %46, i32 %.01, i32 0, i16 zeroext -32768), !dbg !5700, !verifier.code !5585
  call {:cexpr "err"} boogie_si_record_i32($i33);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4660, 15} true;
  assume {:verifier.code 0} true;
  $i34 := $slt.i32($i33, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4660, 11} true;
  assume {:verifier.code 0} true;
  $i35 := $i33;
  assume {:branchcond $i34} true;
  goto $bb19, $bb20;
$bb18:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4671, 5} true;
  assume {:verifier.code 0} true;
  $i37 := 0;
  goto $bb22;
$bb19:
  assume ($i34 == 1);
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4661, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $i35;
  goto $bb5;
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4665, 13} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i27, 1);
  // WARNING: %52 = add nsw i32 %.01, 1, !dbg !5706, !verifier.code !5585
...
$bb22:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4671, 15} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb23:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4673, 13} true;
  assume {:verifier.code 0} true;
  $i38 := $slt.i32($i37, 5);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4673, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i38} true;
  goto $bb24, $bb25;
$bb24:
  assume ($i38 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4675, 7} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb25:
  assume !(($i38 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4676, 9} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb26:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4679, 21} true;
  assume {:verifier.code 0} true;
  $i39 := $p2i.ref.i64($p0);
  // WARNING: %60 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5722, !verifier.code !5585
  call {:cexpr "__cil_tmp32"} boogie_si_record_i64($i39);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4680, 33} true;
  assume {:verifier.code 0} true;
  $i40 := $add.i64($i39, 8);
  // WARNING: %61 = add i64 %60, 8, !dbg !5726, !verifier.code !5585
  call {:cexpr "__cil_tmp33"} boogie_si_record_i64($i40);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4681, 23} true;
  assume {:verifier.code 0} true;
  $p41 := $i2p.i64.ref($i40);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4681, 21} true;
  assume {:verifier.code 0} true;
  $p42 := $load.ref($M.0, $p41);
  // WARNING: call void @llvm.dbg.value(metadata %struct.mii_bus* %63, i64 0, metadata !6001, metadata !5583), !dbg !6002, !verifier.code !5585
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4683, 13} true;
  assume {:verifier.code 0} true;
  call $i43 := mdiobus_read($p42, $i37, 0);
  // WARNING: %64 = call i32 @mdiobus_read(%struct.mii_bus* %63, i32 %.1, i32 0), !dbg !5735, !verifier.code !5585
  call {:cexpr "err"} boogie_si_record_i32($i43);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4684, 13} true;
  assume {:verifier.code 0} true;
  $i44 := $add.i32($i37, 1);
  // WARNING: %65 = add nsw i32 %.1, 1, !dbg !5736, !verifier.code !5585
  ...
  goto $bb22;
$bb27:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4690, 5} true;
  assume {:verifier.code 0} true;
  call __const_udelay(8590000);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4691, 26} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "full_reset_performed"} boogie_si_record_i32(1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4693, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb28:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4697, 17} true;
  assume {:verifier.code 0} true;
  $i45 := $p2i.ref.i64($p0);
  // WARNING: %69 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5744, !verifier.code !5585
  call {:cexpr "__cil_tmp36"} boogie_si_record_i64($i45);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4698, 29} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i64($i45, 800);
  // WARNING: %70 = add i64 %69, 800, !dbg !5748, !verifier.code !5585
  call {:cexpr "__cil_tmp37"} boogie_si_record_i64($i46);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4699, 19} true;
  assume {:verifier.code 0} true;
  $p47 := $i2p.i64.ref($i46);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4699, 17} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i32($M.0, $p47);
  // WARNING: %72 = load i32, i32* %71, align 4, !dbg !5752, !verifier.code !5585
  call {:cexpr "__cil_tmp38"} boogie_si_record_i32($i48);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4700, 19} true;
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i48, 4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4700, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb29, $bb30;
$bb29:
  assume ($i49 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4702, 19} true;
  assume {:verifier.code 0} true;
  $i50 := $p2i.ref.i64($p0);
  // WARNING: %75 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5758, !verifier.code !5585
  call {:cexpr "__cil_tmp39"} boogie_si_record_i64($i50);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4703, 31} true;
  assume {:verifier.code 0} true;
  $i51 := $add.i64($i50, 788);
  // WARNING: %76 = add i64 %75, 788, !dbg !5763, !verifier.code !5585
  call {:cexpr "__cil_tmp40"} boogie_si_record_i64($i51);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4704, 7} true;
  assume {:verifier.code 0} true;
  $p52 := $i2p.i64.ref($i51);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4704, 38} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p52, 6);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4705, 19} true;
  assume {:verifier.code 0} true;
  $i53 := $p2i.ref.i64($p0);
  // WARNING: %78 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5768, !verifier.code !5585
  call {:cexpr "__cil_tmp41"} boogie_si_record_i64($i53);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4706, 31} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i64($i53, 804);
  // WARNING: %79 = add i64 %78, 804, !dbg !5771, !verifier.code !5585
  call {:cexpr "__cil_tmp42"} boogie_si_record_i64($i54);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4707, 7} true;
  assume {:verifier.code 0} true;
  $p55 := $i2p.i64.ref($i54);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4707, 27} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p55, 100);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4708, 19} true;
  assume {:verifier.code 0} true;
  $i56 := $p2i.ref.i64($p0);
  // WARNING: %81 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5776, !verifier.code !5585
  call {:cexpr "__cil_tmp43"} boogie_si_record_i64($i56);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4709, 31} true;
  assume {:verifier.code 0} true;
  $i57 := $add.i64($i56, 808);
  // WARNING: %82 = add i64 %81, 808, !dbg !5779, !verifier.code !5585
  call {:cexpr "__cil_tmp44"} boogie_si_record_i64($i57);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4710, 7} true;
  assume {:verifier.code 0} true;
  $p58 := $i2p.i64.ref($i57);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4710, 27} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p58, 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4711, 19} true;
  assume {:verifier.code 0} true;
  $i59 := $p2i.ref.i64($p0);
  // WARNING: %84 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5784, !verifier.code !5585
  call {:cexpr "__cil_tmp45"} boogie_si_record_i64($i59);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4712, 31} true;
  assume {:verifier.code 0} true;
  $i60 := $add.i64($i59, 820);
  // WARNING: %85 = add i64 %84, 820, !dbg !5787, !verifier.code !5585
  call {:cexpr "__cil_tmp46"} boogie_si_record_i64($i60);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4713, 7} true;
  assume {:verifier.code 0} true;
  $p61 := $i2p.i64.ref($i60);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4713, 27} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p61, 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4714, 19} true;
  assume {:verifier.code 0} true;
  $i62 := $p2i.ref.i64($p0);
  // WARNING: %87 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5792, !verifier.code !5585
  call {:cexpr "__cil_tmp47"} boogie_si_record_i64($i62);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4715, 31} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i64($i62, 1080);
  // WARNING: %88 = add i64 %87, 1080, !dbg !5795, !verifier.code !5585
  call {:cexpr "__cil_tmp48"} boogie_si_record_i64($i63);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4716, 21} true;
  assume {:verifier.code 0} true;
  $p64 := $i2p.i64.ref($i63);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4716, 19} true;
  assume {:verifier.code 0} true;
  $p65 := $load.ref($M.0, $p64);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4717, 5} true;
  assume {:verifier.code 0} true;
  call netif_carrier_on($p65);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4719, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb30:
  assume !(($i49 == 1));
  ...
  goto $bb31;
$bb31:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4723, 3} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  goto $bb5;
}
const ip175c_config_aneg: ref;
axiom (ip175c_config_aneg == $sub.ref(0, 32830));
procedure  ip175c_config_aneg($p0: ref)
  returns ($r: i32)
{
  var $i1: i64;
  var $i2: i64;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4911, 16} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  // WARNING: %2 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5586, !verifier.code !5585
  call {:cexpr "__cil_tmp2"} boogie_si_record_i64($i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4912, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i64($i1, 800);
  // WARNING: %3 = add i64 %2, 800, !dbg !5591, !verifier.code !5585
  call {:cexpr "__cil_tmp3"} boogie_si_record_i64($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4913, 18} true;
  assume {:verifier.code 0} true;
  $p3 := $i2p.i64.ref($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4913, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p3);
  // WARNING: %5 = load i32, i32* %4, align 4, !dbg !5595, !verifier.code !5585
  call {:cexpr "__cil_tmp4"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4914, 18} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4914, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4916, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := genphy_config_aneg($p0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4918, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4922, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const ip175c_read_status: ref;
axiom (ip175c_read_status == $sub.ref(0, 33862));
procedure  ip175c_read_status($p0: ref)
  returns ($r: i32)
{
  var $i1: i64;
  var $i2: i64;
  ...
  var $p9: ref;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4888, 16} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i64($p0);
  // WARNING: %2 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5586, !verifier.code !5585
  call {:cexpr "__cil_tmp2"} boogie_si_record_i64($i1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4889, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i64($i1, 800);
  // WARNING: %3 = add i64 %2, 800, !dbg !5591, !verifier.code !5585
  call {:cexpr "__cil_tmp3"} boogie_si_record_i64($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4890, 18} true;
  assume {:verifier.code 0} true;
  $p3 := $i2p.i64.ref($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4890, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p3);
  // WARNING: %5 = load i32, i32* %4, align 4, !dbg !5595, !verifier.code !5585
  call {:cexpr "__cil_tmp4"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4891, 18} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4891, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4893, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := genphy_read_status($p0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4895, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4896, 18} true;
  assume {:verifier.code 0} true;
  $i7 := $p2i.ref.i64($p0);
  // WARNING: %10 = ptrtoint %struct.phy_device* %0 to i64, !dbg !5605, !verifier.code !5585
  call {:cexpr "__cil_tmp5"} boogie_si_record_i64($i7);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4897, 29} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i64($i7, 844);
  // WARNING: %11 = add i64 %10, 844, !dbg !5609, !verifier.code !5585
  call {:cexpr "__cil_tmp6"} boogie_si_record_i64($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4898, 7} true;
  assume {:verifier.code 0} true;
  $p9 := $i2p.i64.ref($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4898, 26} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p9, $sub.i32(0, 2));
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 4901, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__const_udelay == $sub.ref(0, 34894));
procedure  __const_udelay($i0: i64);
const netif_carrier_on: ref;
axiom (netif_carrier_on == $sub.ref(0, 35926));
procedure  netif_carrier_on($p0: ref);
const icplus_exit: ref;
axiom (icplus_exit == $sub.ref(0, 36958));
procedure  icplus_exit()
{
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5051, 3} true;
  assume {:verifier.code 0} true;
  call phy_driver_unregister(ip1001_driver);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5052, 3} true;
  assume {:verifier.code 0} true;
  call phy_driver_unregister(ip101a_g_driver);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5053, 3} true;
  assume {:verifier.code 0} true;
  call phy_driver_unregister(ip175c_driver);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5055, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const phy_driver_unregister: ref;
axiom (phy_driver_unregister == $sub.ref(0, 37990));
procedure  phy_driver_unregister($p0: ref);
const main: ref;
axiom (main == $sub.ref(0, 39022));
...
$bb0:
  call $initialize();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5095, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5096, 3} true;
  assume {:verifier.code 0} true;
  call ldv_initialize();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5097, 13} true;
  assume {:verifier.code 0} true;
  call $i0 := icplus_init();
  // WARNING: %1 = call i32 @icplus_init(), !dbg !5587, !verifier.code !5585
  call {:cexpr "tmp___7"} boogie_si_record_i32($i0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5099, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5099, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5100, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  ...
  goto $bb4;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5144, 3} true;
  assume {:verifier.code 0} true;
  call ldv_check_final_state();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5146, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5105, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5105, 13} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5108, 15} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  // WARNING: %8 = call i32 @__VERIFIER_nondet_int(), !dbg !5600, !verifier.code !5603
  call {:cexpr "tmp___9"} boogie_si_record_i32($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5110, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5110, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i3 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5112, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !(($i3 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5113, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5116, 15} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i4);
  // WARNING: %13 = call i32 @__VERIFIER_nondet_int(), !dbg !5613, !verifier.code !5603
  call {:cexpr "tmp___8"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5118, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5118, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb11, $bb12;
$bb10:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5140, 3} true;
  assume {:verifier.code 0} true;
  call icplus_exit();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5141, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb11:
  assume ($i5 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5119, 7} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !(($i5 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5122, 7} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5126, 9} true;
  assume {:verifier.code 0} true;
  call $i6 := ip101a_g_ack_interrupt($u0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5128, 9} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb14:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5130, 9} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb15:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5123, 11} true;
  assume {:verifier.code 0} true;
...
axiom (ldv_initialize == $sub.ref(0, 40054));
procedure  ldv_initialize();
const ldv_check_final_state: ref;
axiom (ldv_check_final_state == $sub.ref(0, 41086));
procedure  ldv_check_final_state()
{
  var $i0: i32;
  var $i1: i1;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5281, 7} true;
  assume {:verifier.code 0} true;
  $i0 := $M.3;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5281, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5281, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5283, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5285, 5} true;
  assume {:verifier.code 0} true;
  call ldv_blast_assert();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5288, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const ldv_blast_assert: ref;
axiom (ldv_blast_assert == $sub.ref(0, 42118));
procedure  ldv_blast_assert()
{
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5152, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5153, 10} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--icplus.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-8XUrbD.c", 5155, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 43150));
procedure  __VERIFIER_assume($i0: i32)
{
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !6214, metadata !5583), !dbg !6215, !verifier.code !5585
...
axiom (__SMACK_code == $sub.ref(0, 44182));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 45214));
...
axiom (__VERIFIER_error == $sub.ref(0, 46246));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 47278));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 48310));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 49342));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 50374));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 51406));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 52438));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 53470));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 54502));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 55534));
...
$bb0:
  ...
  // WARNING: %1 = call i32 @__SMACK_nondet_int(), !dbg !5582, !verifier.code !5583
...
axiom (__SMACK_nondet_int == $sub.ref(0, 56566));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 57598));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 58630));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 59662));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 60694));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 61726));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 62758));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 63790));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 64822));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 65854));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 66886));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 67918));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 68950));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 69982));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 71014));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 72046));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 73078));
...
axiom (__SMACK_top_decl == $sub.ref(0, 74110));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 75142));
...
axiom (llvm.dbg.value == $sub.ref(0, 76174));
procedure  llvm.dbg.value($p0: ref, $i1: i64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 77206));
...
$bb0:
  ...
  $M.0 := $store.ref($M.0, llvm.used, __mod_description34);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 8), __mod_author35);
  $M.0 := $store.ref($M.0, $add.ref(llvm.used, 16), __mod_license36);
  $M.0 := $store.i8($M.0, __mod_description34, 100);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 1), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 2), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 3), 99);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 4), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 5), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 6), 112);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 7), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 8), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 9), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 10), 110);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 11), 61);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 12), 73);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 13), 67);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 14), 80);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 15), 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 16), 117);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 17), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 18), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 19), 73);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 20), 80);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 21), 49);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 22), 55);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 23), 53);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 24), 67);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 25), 47);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 26), 73);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 27), 80);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 28), 49);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 29), 48);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 30), 49);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 31), 65);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 32), 47);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 33), 73);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 34), 80);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 35), 49);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 36), 48);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 37), 49);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 38), 71);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 39), 47);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 40), 73);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 41), 67);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 42), 49);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 43), 48);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 44), 48);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 45), 49);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 46), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 47), 80);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 48), 72);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 49), 89);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 50), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 51), 100);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 52), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 53), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 54), 118);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 55), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 56), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 57), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_description34, 58), 0);
  $M.0 := $store.i8($M.0, __mod_author35, 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 1), 117);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 2), 116);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 3), 104);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 4), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 5), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 6), 61);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 7), 77);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 8), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 9), 99);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 10), 104);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 11), 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 12), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 13), 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 14), 32);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 15), 66);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 16), 97);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 17), 114);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 18), 107);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 19), 111);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 20), 119);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 21), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 22), 107);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 23), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_author35, 24), 0);
  $M.0 := $store.i8($M.0, __mod_license36, 108);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 1), 105);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 2), 99);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 3), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 4), 110);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 5), 115);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 6), 101);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 7), 61);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 8), 71);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 9), 80);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 10), 76);
  $M.0 := $store.i8($M.0, $add.ref(__mod_license36, 11), 0);
  $M.4 := $store.i32($M.4, icplus_tbl, 37948800);
  $M.5 := $store.i32($M.5, $add.ref(icplus_tbl, 4), 268435440);
  $M.4 := $store.i32($M.4, $add.ref(icplus_tbl, 8), 37948816);
  $M.5 := $store.i32($M.5, $add.ref($add.ref(icplus_tbl, 8), 4), 268435440);
  $M.4 := $store.i32($M.4, $add.ref(icplus_tbl, 16), 37948500);
  $M.5 := $store.i32($M.5, $add.ref($add.ref(icplus_tbl, 16), 4), 268435440);
  $M.1 := 0;
  call {:cexpr "full_reset_performed"} boogie_si_record_i32(0);
  $M.0 := $store.i32($M.0, ip175c_driver, 37948800);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 8), .str.2);
  $M.0 := $store.i32($M.0, $add.ref(ip175c_driver, 16), 268435440);
  $M.0 := $store.i32($M.0, $add.ref(ip175c_driver, 20), 719);
  $M.0 := $store.i32($M.0, $add.ref(ip175c_driver, 24), 0);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 32), ip175c_config_init);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 40), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 48), genphy_suspend);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 56), genphy_resume);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 64), ip175c_config_aneg);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 72), ip175c_read_status);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 80), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 88), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 96), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 104), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 112), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 120), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 128), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip175c_driver, 136), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 8), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 16), __this_module);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 24), $0.ref);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(ip175c_driver, 136), 32), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 40), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 48), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 56), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 64), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 72), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 80), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 88), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 96), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip175c_driver, 136), 104), $0.ref);
  $M.0 := $store.i32($M.0, ip101a_g_driver, 37948500);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 8), .str.1);
  $M.0 := $store.i32($M.0, $add.ref(ip101a_g_driver, 16), 268435440);
  $M.0 := $store.i32($M.0, $add.ref(ip101a_g_driver, 20), 25295);
  $M.0 := $store.i32($M.0, $add.ref(ip101a_g_driver, 24), 1);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 32), ip101a_g_config_init);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 40), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 48), genphy_suspend);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 56), genphy_resume);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 64), genphy_config_aneg);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 72), genphy_read_status);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 80), ip101a_g_ack_interrupt);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 88), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 96), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 104), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 112), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 120), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 128), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip101a_g_driver, 136), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 8), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 16), __this_module);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 24), $0.ref);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 32), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 40), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 48), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 56), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 64), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 72), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 80), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 88), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 96), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip101a_g_driver, 136), 104), $0.ref);
  $M.0 := $store.i32($M.0, ip1001_driver, 37948816);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 8), .str);
  $M.0 := $store.i32($M.0, $add.ref(ip1001_driver, 16), 268435440);
  $M.0 := $store.i32($M.0, $add.ref(ip1001_driver, 20), 25343);
  $M.0 := $store.i32($M.0, $add.ref(ip1001_driver, 24), 0);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 32), ip1001_config_init);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 40), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 48), genphy_suspend);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 56), genphy_resume);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 64), genphy_config_aneg);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 72), genphy_read_status);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 80), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 88), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 96), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 104), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 112), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 120), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 128), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref(ip1001_driver, 136), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 8), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 16), __this_module);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 24), $0.ref);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(ip1001_driver, 136), 32), 0);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 40), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 48), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 56), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 64), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 72), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 80), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 88), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 96), $0.ref);
  $M.0 := $store.ref($M.0, $add.ref($add.ref(ip1001_driver, 136), 104), $0.ref);
  $exn := false;
  return;
}
const $u0: ref;
