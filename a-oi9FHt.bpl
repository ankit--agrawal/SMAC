...
// via /mnt/local/smack-project/smack/bin/smack -x=svcomp --time-limit 1800 /proj/SMACK/sv-benchmarks/c/ldv-linux-3.4-simple/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c --bit-precise --verifier-options  /bopt:z3opt:SMT.MBQI=true /bopt:z3opt:SMT.MBQI.MAX_ITERATIONS=414 /deepAsserts /di /doNotUseLabels /noCallTreeReuse /nonUniformUnfolding /trackAllVars /noArrayTheory --unroll 16
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 70683));
...
const {:count 12} __mod_license139: ref;
axiom (__mod_license139 == $sub.ref(0, 4140));
const {:count 47} __mod_author140: ref;
axiom (__mod_author140 == $sub.ref(0, 5211));
const {:count 64} __mod_description141: ref;
axiom (__mod_description141 == $sub.ref(0, 6299));
const {:count 4} partition_info: ref;
axiom (partition_info == $sub.ref(0, 7483));
const mymtd: ref;
axiom (mymtd == $sub.ref(0, 8515));
const netsc520_map: ref;
axiom (netsc520_map == $sub.ref(0, 9675));
const .str: ref;
axiom (.str == $sub.ref(0, 10741));
const {:count 27} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 11792));
const {:count 10} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 12826));
const {:count 8} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 13858));
const {:count 8} .str.4: ref;
axiom (.str.4 == $sub.ref(0, 14890));
const __this_module: ref;
axiom (__this_module == $sub.ref(0, 32776));
const {:count 20} .str.5: ref;
axiom (.str.5 == $sub.ref(0, 15934));
const {:count 21} .str.6: ref;
axiom (.str.6 == $sub.ref(0, 16979));
const {:count 18} .str.7: ref;
axiom (.str.7 == $sub.ref(0, 18021));
const {:count 21} .str.8: ref;
axiom (.str.8 == $sub.ref(0, 19066));
const {:count 19} .str.9: ref;
axiom (.str.9 == $sub.ref(0, 20109));
const {:count 14} .str.2.14: ref;
axiom (.str.2.14 == $sub.ref(0, 21147));
const init_netsc520: ref;
axiom (init_netsc520 == $sub.ref(0, 22179));
  ...
  returns ($r: bv32)
{
  ...
  var $i15: bv32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 931, 18} true;
  assume {:verifier.code 0} true;
  $p0 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 8bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 931, 16} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bytes.bv64($M.0, $p0);
  // WARNING: %2 = load i64, i64* %1, align 8, !dbg !1137, !verifier.code !1133
  call {:cexpr "__cil_tmp2"} boogie_si_record_bv64($i1);
  // WARNING: call void @llvm.dbg.value(metadata i64 %2, i64 0, metadata !1138, metadata !1131), !dbg !1139, !verifier.code !1133
  // WARNING: call void @llvm.dbg.value(metadata i64 %2, i64 0, metadata !1140, metadata !1131), !dbg !1141, !verifier.code !1133
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 934, 18} true;
  assume {:verifier.code 0} true;
  $p2 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 16bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 934, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bytes.bv64($M.0, $p2);
  // WARNING: %4 = load i64, i64* %3, align 8, !dbg !1145, !verifier.code !1133
  call {:cexpr "__cil_tmp5"} boogie_si_record_bv64($i3);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 935, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := printk.ref.bv64.bv64(.str, $i1, $i3);
  // WARNING: %5 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str, i32 0, i32 0), i64 %2, i64 %4), !dbg !1148, !verifier.code !1133
  // WARNING: call void @llvm.dbg.value(metadata i64 add (i64 ptrtoint (%struct.map_info* @netsc520_map to i64), i64 24), i64 0, metadata !1149, metadata !1131), !dbg !1150, !verifier.code !1133
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 938, 18} true;
  assume {:verifier.code 0} true;
  $p5 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 16bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 938, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $load.bytes.bv64($M.0, $p5);
  // WARNING: %7 = load i64, i64* %6, align 8, !dbg !1154, !verifier.code !1133
  call {:cexpr "__cil_tmp8"} boogie_si_record_bv64($i6);
  // WARNING: call void @llvm.dbg.value(metadata i64 %7, i64 0, metadata !1155, metadata !1131), !dbg !1156, !verifier.code !1133
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 940, 19} true;
  assume {:verifier.code 0} true;
  $p7 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 8bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 940, 17} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bytes.bv64($M.0, $p7);
  // WARNING: %9 = load i64, i64* %8, align 8, !dbg !1160, !verifier.code !1133
  call {:cexpr "__cil_tmp10"} boogie_si_record_bv64($i8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 941, 28} true;
  assume {:verifier.code 0} true;
  call $p9 := ioremap_nocache($i6, $i8);
  assume $isExternal($p9);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 941, 5} true;
  assume {:verifier.code 0} true;
  $p10 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 24bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 941, 26} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, $p10, $p9);
  // WARNING: store i8* %10, i8** %11, align 8, !dbg !1165, !verifier.code !1133
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 945, 19} true;
  assume {:verifier.code 0} true;
  $p11 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 24bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 945, 17} true;
  assume {:verifier.code 0} true;
  $p12 := $load.bytes.ref($M.0, $p11);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 946, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.ref($p12, $0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 946, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i13 == 1bv1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 948, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := printk.ref(.str.1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 950, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.bv32(0bv32, 5bv32);
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1003, 1} true;
  assume {:verifier.code 0} true;
  $r := $i15;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 956, 3} true;
  assume {:verifier.code 0} true;
  call simple_map_init(netsc520_map);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 957, 11} true;
  assume {:verifier.code 0} true;
  call $p16 := do_map_probe(.str.2, netsc520_map);
  assume $isExternal($p16);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 957, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := $p16;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 959, 9} true;
  assume {:verifier.code 0} true;
  $p17 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 959, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $ne.ref($p17, $0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 959, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i18 == 1bv1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 961, 13} true;
  assume {:verifier.code 0} true;
  call $p19 := do_map_probe(.str.3, netsc520_map);
  assume $isExternal($p19);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 961, 11} true;
  assume {:verifier.code 0} true;
  $M.1 := $p19;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 963, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 966, 9} true;
  assume {:verifier.code 0} true;
  $p20 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 966, 9} true;
  assume {:verifier.code 0} true;
  $i21 := $ne.ref($p20, $0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 966, 7} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume !(($i21 == 1bv1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 968, 13} true;
  assume {:verifier.code 0} true;
  call $p22 := do_map_probe(.str.4, netsc520_map);
  assume $isExternal($p22);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 968, 11} true;
  assume {:verifier.code 0} true;
  $M.1 := $p22;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 970, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 973, 9} true;
  assume {:verifier.code 0} true;
  $p23 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 973, 9} true;
  assume {:verifier.code 0} true;
  $i24 := $ne.ref($p23, $0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 973, 7} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i24 == 1bv1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 976, 21} true;
  assume {:verifier.code 0} true;
  $p25 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 24bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 976, 19} true;
  assume {:verifier.code 0} true;
  $p26 := $load.bytes.ref($M.0, $p25);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 978, 5} true;
  assume {:verifier.code 0} true;
  call iounmap($p26);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 980, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.bv32(0bv32, 6bv32);
  goto $bb3;
$bb13:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 985, 33} true;
  assume {:verifier.code 0} true;
  $p27 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 985, 17} true;
  assume {:verifier.code 0} true;
  $i28 := $p2i.ref.bv64($p27);
  // WARNING: %40 = ptrtoint %struct.mtd_info* %39 to i64, !dbg !1217, !verifier.code !1133
  call {:cexpr "__cil_tmp16"} boogie_si_record_bv64($i28);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 986, 29} true;
  assume {:verifier.code 0} true;
  $i29 := $add.bv64($i28, 368bv64);
  // WARNING: %41 = add i64 %40, 368, !dbg !1220, !verifier.code !1133
  call {:cexpr "__cil_tmp17"} boogie_si_record_bv64($i29);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 987, 5} true;
  assume {:verifier.code 0} true;
  $p30 := $i2p.bv64.ref($i29);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 987, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, $p30, __this_module);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 989, 17} true;
  assume {:verifier.code 0} true;
  $p31 := $bitcast.ref.ref($0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 991, 17} true;
  assume {:verifier.code 0} true;
  $p32 := $bitcast.ref.ref($0.ref);
  // WARNING: call void @llvm.dbg.value(metadata %struct.mtd_part_parser_data* %44, i64 0, metadata !1233, metadata !1131), !dbg !1234, !verifier.code !1133
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 993, 50} true;
  assume {:verifier.code 0} true;
  $i33 := $add.bv64($p2i.ref.bv64(partition_info), 0bv64);
  // WARNING: %45 = add i64 ptrtoint ([4 x %struct.mtd_partition]* @partition_info to i64), 0, !dbg !1237, !verifier.code !1133
  call {:cexpr "__cil_tmp23"} boogie_si_record_bv64($i33);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 994, 17} true;
  assume {:verifier.code 0} true;
  $p34 := $i2p.bv64.ref($i33);
  // WARNING: call void @llvm.dbg.value(metadata %struct.mtd_partition* %46, i64 0, metadata !1243, metadata !1131), !dbg !1244, !verifier.code !1133
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 997, 29} true;
  assume {:verifier.code 0} true;
  $i35 := $add.bv64(4bv64, 0bv64);
  // WARNING: %47 = add i64 4, 0, !dbg !1247, !verifier.code !1133
  call {:cexpr "__cil_tmp27"} boogie_si_record_bv64($i35);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 998, 17} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.bv64.bv32($i35);
  // WARNING: %48 = trunc i64 %47 to i32, !dbg !1250, !verifier.code !1133
  call {:cexpr "__cil_tmp28"} boogie_si_record_bv32($i36);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 999, 29} true;
  assume {:verifier.code 0} true;
  $p37 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 999, 3} true;
  assume {:verifier.code 0} true;
  call $i38 := mtd_device_parse_register($p37, $p31, $p32, $p34, $i36);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1001, 3} true;
  assume {:verifier.code 0} true;
  $i15 := 0bv32;
  goto $bb3;
}
const printk: ref;
axiom (printk == $sub.ref(0, 23211));
procedure  printk.ref($p0: ref)
  returns ($r: bv32);
procedure  printk.ref.bv64.bv64($p0: ref, p.1: bv64, p.2: bv64)
  returns ($r: bv32);
const ioremap_nocache: ref;
axiom (ioremap_nocache == $sub.ref(0, 24243));
procedure  ioremap_nocache($i0: bv64, $i1: bv64)
  returns ($r: ref);
const simple_map_init: ref;
axiom (simple_map_init == $sub.ref(0, 25275));
procedure  simple_map_init($p0: ref);
const do_map_probe: ref;
axiom (do_map_probe == $sub.ref(0, 26307));
procedure  do_map_probe($p0: ref, $p1: ref)
  returns ($r: ref);
const iounmap: ref;
axiom (iounmap == $sub.ref(0, 27339));
procedure  iounmap($p0: ref);
const mtd_device_parse_register: ref;
axiom (mtd_device_parse_register == $sub.ref(0, 28371));
procedure  mtd_device_parse_register($p0: ref, $p1: ref, $p2: ref, $p3: ref, $i4: bv32)
  returns ($r: bv32);
const cleanup_netsc520: ref;
axiom (cleanup_netsc520 == $sub.ref(0, 29403));
procedure  cleanup_netsc520()
{
  ...
  var $p10: ref;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1013, 7} true;
  assume {:verifier.code 0} true;
  $p0 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1013, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1bv1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1015, 27} true;
  assume {:verifier.code 0} true;
  $p2 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1015, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := mtd_device_unregister($p2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1016, 17} true;
  assume {:verifier.code 0} true;
  $p4 := $M.1;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1016, 5} true;
  assume {:verifier.code 0} true;
  call map_destroy($p4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1018, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1bv1));
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1023, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 24bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1023, 7} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i7 == 1bv1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1026, 20} true;
  assume {:verifier.code 0} true;
  $p8 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 24bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1026, 18} true;
  assume {:verifier.code 0} true;
  $p9 := $load.bytes.ref($M.0, $p8);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1028, 5} true;
  assume {:verifier.code 0} true;
  call iounmap($p9);
  // WARNING: call void @iounmap(i8* %14), !dbg !1160, !verifier.code !1133
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1030, 7} true;
  assume {:verifier.code 0} true;
  $p10 := $i2p.bv64.ref($add.bv64($p2i.ref.bv64(netsc520_map), 24bv64));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1030, 28} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, $p10, $0.ref);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1032, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume !(($i7 == 1bv1));
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1036, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const mtd_device_unregister: ref;
axiom (mtd_device_unregister == $sub.ref(0, 30435));
procedure  mtd_device_unregister($p0: ref)
  returns ($r: bv32);
const map_destroy: ref;
axiom (map_destroy == $sub.ref(0, 31467));
procedure  map_destroy($p0: ref);
const main: ref;
axiom (main == $sub.ref(0, 32499));
...
$bb0:
  call $initialize();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1107, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1108, 3} true;
  assume {:verifier.code 0} true;
  call ldv_initialize();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1109, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := init_netsc520();
  // WARNING: %1 = call i32 @init_netsc520(), !dbg !1135, !verifier.code !1133
  call {:cexpr "tmp"} boogie_si_record_bv32($i0);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1111, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.bv32($i0, 0bv32);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1111, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1bv1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1112, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1bv1));
  ...
  goto $bb4;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1147, 3} true;
  assume {:verifier.code 0} true;
  call ldv_check_final_state();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1149, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1117, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1117, 13} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1120, 15} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i2);
  // WARNING: %8 = call i32 @__VERIFIER_nondet_int(), !dbg !1148, !verifier.code !1151
  call {:cexpr "tmp___1"} boogie_si_record_bv32($i2);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1122, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.bv32($i2, 0bv32);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1122, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i3 == 1bv1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1124, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !(($i3 == 1bv1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1125, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1128, 15} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i4);
  // WARNING: %13 = call i32 @__VERIFIER_nondet_int(), !dbg !1161, !verifier.code !1151
  call {:cexpr "tmp___0"} boogie_si_record_bv32($i4);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1131, 5} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1143, 3} true;
  assume {:verifier.code 0} true;
  call cleanup_netsc520();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1144, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb11:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1134, 7} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb12:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1132, 9} true;
  assume {:verifier.code 0} true;
...
axiom (ldv_initialize == $sub.ref(0, 33531));
procedure  ldv_initialize();
const ldv_check_final_state: ref;
axiom (ldv_check_final_state == $sub.ref(0, 34563));
procedure  ldv_check_final_state()
{
  var $i0: bv32;
  var $i1: bv1;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1284, 7} true;
  assume {:verifier.code 0} true;
  $i0 := $M.3;
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1284, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.bv32($i0, 1bv32);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1284, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i1 == 1bv1);
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1286, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1bv1));
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1288, 5} true;
  assume {:verifier.code 0} true;
  call ldv_blast_assert();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1291, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const ldv_blast_assert: ref;
axiom (ldv_blast_assert == $sub.ref(0, 35595));
procedure  ldv_blast_assert()
{
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1155, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1156, 10} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_error();
  assume {:sourceloc "/proj/SMACK/smac/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--mtd--maps--netsc520.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-mNnMBy.c", 1158, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 36627));
procedure  __VERIFIER_assume($i0: bv32)
{
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !1362, metadata !1131), !dbg !1363, !verifier.code !1133
...
axiom (__SMACK_code == $sub.ref(0, 37659));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 38691));
...
axiom (__VERIFIER_error == $sub.ref(0, 39723));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 40755));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 41787));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 42819));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 43851));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 44883));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 45915));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 46947));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 47979));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 49011));
...
$bb0:
  ...
  // WARNING: %1 = call i32 @__SMACK_nondet_int(), !dbg !1130, !verifier.code !1131
...
axiom (__SMACK_nondet_int == $sub.ref(0, 50043));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 51075));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 52107));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 53139));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 54171));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 55203));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 56235));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 57267));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 58299));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 59331));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 60363));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 61395));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 62427));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 63459));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 64491));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 65523));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 66555));
...
axiom (__SMACK_top_decl == $sub.ref(0, 67587));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 68619));
...
axiom (llvm.dbg.value == $sub.ref(0, 69651));
procedure  llvm.dbg.value($p0: ref, $i1: bv64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 70683));
...
$bb0:
  ...
  $M.0 := $store.bytes.ref($M.0, llvm.used, __mod_license139);
  $M.0 := $store.bytes.ref($M.0, $add.ref(llvm.used, 8), __mod_author140);
  $M.0 := $store.bytes.ref($M.0, $add.ref(llvm.used, 16), __mod_description141);
  $M.0 := $store.bytes.bv8($M.0, __mod_license139, 108bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 1), 105bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 2), 99bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 3), 101bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 4), 110bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 5), 115bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 6), 101bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 7), 61bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 8), 71bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 9), 80bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 10), 76bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_license139, 11), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, __mod_author140, 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 1), 117bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 2), 116bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 3), 104bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 4), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 5), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 6), 61bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 7), 77bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 8), 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 9), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 10), 107bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 11), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 12), 76bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 13), 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 14), 110bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 15), 103bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 16), 115bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 17), 100bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 18), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 19), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 20), 102bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 21), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 22), 60bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 23), 109bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 24), 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 25), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 26), 107bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 27), 46bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 28), 108bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 29), 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 30), 110bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 31), 103bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 32), 115bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 33), 100bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 34), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 35), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 36), 102bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 37), 64bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 38), 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 39), 109bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 40), 100bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 41), 46bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 42), 99bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 43), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 44), 109bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 45), 62bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_author140, 46), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, __mod_description141, 100bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 1), 101bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 2), 115bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 3), 99bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 4), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 5), 105bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 6), 112bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 7), 116bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 8), 105bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 9), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 10), 110bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 11), 61bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 12), 77bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 13), 84bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 14), 68bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 15), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 16), 109bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 17), 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 18), 112bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 19), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 20), 100bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 21), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 22), 105bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 23), 118bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 24), 101bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 25), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 26), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 27), 102bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 28), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 29), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 30), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 31), 65bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 32), 77bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 33), 68bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 34), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 35), 78bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 36), 101bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 37), 116bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 38), 83bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 39), 99bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 40), 53bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 41), 50bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 42), 48bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 43), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 44), 68bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 45), 101bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 46), 109bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 47), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 48), 110bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 49), 115bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 50), 116bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 51), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 52), 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 53), 116bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 54), 105bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 55), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 56), 110bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 57), 32bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 58), 66bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 59), 111bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 60), 97bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 61), 114bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 62), 100bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref(__mod_description141, 63), 0bv8);
  $M.4 := $store.ref($M.4, partition_info, .str.6);
  $M.5 := $store.bv64($M.5, $add.ref(partition_info, 8), 786432bv64);
  $M.6 := $store.bv64($M.6, $add.ref(partition_info, 16), 0bv64);
  $M.7 := $store.bv32($M.7, $add.ref(partition_info, 24), 0bv32);
  $M.8 := $store.ref($M.8, $add.ref(partition_info, 32), $0.ref);
  $M.4 := $store.ref($M.4, $add.ref(partition_info, 40), .str.7);
  $M.5 := $store.bv64($M.5, $add.ref($add.ref(partition_info, 40), 8), 262144bv64);
  $M.6 := $store.bv64($M.6, $add.ref($add.ref(partition_info, 40), 16), 786432bv64);
  $M.7 := $store.bv32($M.7, $add.ref($add.ref(partition_info, 40), 24), 0bv32);
  $M.8 := $store.ref($M.8, $add.ref($add.ref(partition_info, 40), 32), $0.ref);
  $M.4 := $store.ref($M.4, $add.ref(partition_info, 80), .str.8);
  $M.5 := $store.bv64($M.5, $add.ref($add.ref(partition_info, 80), 8), 15204352bv64);
  $M.6 := $store.bv64($M.6, $add.ref($add.ref(partition_info, 80), 16), 1048576bv64);
  $M.7 := $store.bv32($M.7, $add.ref($add.ref(partition_info, 80), 24), 0bv32);
  $M.8 := $store.ref($M.8, $add.ref($add.ref(partition_info, 80), 32), $0.ref);
  $M.4 := $store.ref($M.4, $add.ref(partition_info, 120), .str.9);
  $M.5 := $store.bv64($M.5, $add.ref($add.ref(partition_info, 120), 8), 524288bv64);
  $M.6 := $store.bv64($M.6, $add.ref($add.ref(partition_info, 120), 16), 16252928bv64);
  $M.7 := $store.bv32($M.7, $add.ref($add.ref(partition_info, 120), 24), 0bv32);
  $M.8 := $store.ref($M.8, $add.ref($add.ref(partition_info, 120), 32), $0.ref);
  $M.1 := $0.ref;
  $M.0 := $store.bytes.ref($M.0, netsc520_map, .str.5);
  $M.0 := $store.bytes.bv64($M.0, $add.ref(netsc520_map, 8), 1048576bv64);
  $M.0 := $store.bytes.bv64($M.0, $add.ref(netsc520_map, 16), 2097152bv64);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 24), $0.ref);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 32), $0.ref);
  $M.0 := $store.bytes.bv32($M.0, $add.ref(netsc520_map, 40), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref(netsc520_map, 44), 4bv32);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 48), $0.ref);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 56), $0.ref);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 64), $0.ref);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 72), $0.ref);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 80), $0.ref);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 88), $0.ref);
  $M.0 := $store.bytes.bv64($M.0, $add.ref(netsc520_map, 96), 0bv64);
  $M.0 := $store.bytes.bv64($M.0, $add.ref(netsc520_map, 104), 0bv64);
  $M.0 := $store.bytes.bv64($M.0, $add.ref(netsc520_map, 112), 0bv64);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 120), $0.ref);
  $M.0 := $store.bytes.ref($M.0, $add.ref(netsc520_map, 128), $0.ref);
  $exn := false;
  return;
}
