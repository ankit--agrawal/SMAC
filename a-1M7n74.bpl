...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 48865));
...
const {:count 29} encore_enltv_fm53: ref;
axiom (encore_enltv_fm53 == $sub.ref(0, 3312));
const encore_enltv_fm53_map: ref;
axiom (encore_enltv_fm53_map == $sub.ref(0, 4464));
const .str: ref;
axiom (.str == $sub.ref(0, 5509));
const {:count 14} .str.1.4: ref;
axiom (.str.1.4 == $sub.ref(0, 6547));
const {:count 14} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 7585));
const main: ref;
axiom (main == $sub.ref(0, 8617));
procedure main()
{
  var $i0: i32;
  var $i1: i1;
...
$bb0:
  call $initialize();
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 316, 20} true;
  ...
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 317, 3} true;
  assume {:verifier.code 0} true;
  call ldv_initialize();
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 318, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := init_rc_map_encore_enltv_fm53();
  // WARNING: %1 = call i32 @init_rc_map_encore_enltv_fm53(), !dbg !158, !verifier.code !156
  call {:cexpr "tmp"} boogie_si_record_i32($i0);
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 320, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 320, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 321, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  ...
  goto $bb4;
$bb3:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 355, 3} true;
  assume {:verifier.code 0} true;
  call ldv_check_final_state();
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 357, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 342, 13} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  // WARNING: %6 = call i32 @__VERIFIER_nondet_int(), !dbg !167, !verifier.code !169
  call {:cexpr "tmp___1"} boogie_si_record_i32($i2);
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 344, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 344, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 347, 5} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb8:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 345, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 328, 13} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i4);
  // WARNING: %9 = call i32 @__VERIFIER_nondet_int(), !dbg !175, !verifier.code !169
  call {:cexpr "tmp___0"} boogie_si_record_i32($i4);
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 331, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 334, 5} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb11:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 332, 7} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume !((0 == 1));
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 335, 10} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 342, 13} true;
  ...
  // WARNING: %17 = call i32 @__VERIFIER_nondet_int(), !dbg !167, !verifier.code !169
...
$bb18:
  ...
  goto $bb7;
$bb19:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 351, 3} true;
  assume {:verifier.code 0} true;
  call exit_rc_map_encore_enltv_fm53();
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 352, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const ldv_initialize: ref;
axiom (ldv_initialize == $sub.ref(0, 9649));
procedure ldv_initialize();
const init_rc_map_encore_enltv_fm53: ref;
axiom (init_rc_map_encore_enltv_fm53 == $sub.ref(0, 10681));
procedure init_rc_map_encore_enltv_fm53()
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 290, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := rc_map_register(encore_enltv_fm53_map);
  // WARNING: %1 = call i32 @rc_map_register(%struct.rc_map_list* @encore_enltv_fm53_map), !dbg !153, !verifier.code !156
  call {:cexpr "tmp"} boogie_si_record_i32($i0);
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 292, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
}
const exit_rc_map_encore_enltv_fm53: ref;
axiom (exit_rc_map_encore_enltv_fm53 == $sub.ref(0, 11713));
procedure exit_rc_map_encore_enltv_fm53()
{
$bb0:
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 300, 3} true;
  assume {:verifier.code 0} true;
  call rc_map_unregister(encore_enltv_fm53_map);
  assume {:sourceloc "/proj/SMACK/smac/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-encore-enltv-fm53.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out-tqB8L_.c", 302, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const ldv_check_final_state: ref;
axiom (ldv_check_final_state == $sub.ref(0, 12745));
procedure ldv_check_final_state();
const rc_map_unregister: ref;
axiom (rc_map_unregister == $sub.ref(0, 13777));
procedure rc_map_unregister($p0: ref);
const rc_map_register: ref;
axiom (rc_map_register == $sub.ref(0, 14809));
procedure rc_map_register($p0: ref)
  returns ($r: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 15841));
procedure __VERIFIER_assume($i0: i32)
{
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !213, metadata !160), !dbg !214, !verifier.code !156
...
axiom (__SMACK_code == $sub.ref(0, 16873));
procedure __SMACK_code.ref($p0: ref);
procedure __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 17905));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 18937));
procedure __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 19969));
procedure __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 21001));
procedure __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 22033));
procedure __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 23065));
procedure __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 24097));
procedure __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 25129));
procedure __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 26161));
procedure __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 27193));
...
$bb0:
  ...
  // WARNING: %1 = call i32 @__SMACK_nondet_int(), !dbg !153, !verifier.code !154
...
axiom (__SMACK_nondet_int == $sub.ref(0, 28225));
procedure __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 29257));
procedure __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 30289));
procedure __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 31321));
procedure __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 32353));
procedure __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 33385));
procedure __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 34417));
procedure __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 35449));
procedure __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 36481));
procedure __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 37513));
procedure __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 38545));
procedure __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 39577));
procedure __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 40609));
procedure __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 41641));
procedure __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 42673));
procedure __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 43705));
procedure __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 44737));
...
axiom (__SMACK_top_decl == $sub.ref(0, 45769));
procedure __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 46801));
...
axiom (llvm.dbg.value == $sub.ref(0, 47833));
procedure llvm.dbg.value($p0: ref, $i1: i64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 48865));
...
$bb0:
  ...
  $M.2 := $store.i32($M.2, encore_enltv_fm53, 16);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 4), 356);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 8), 6);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 8), 4), 113);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 16), 9);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 16), 4), 2);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 24), 29);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 24), 4), 3);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 32), 31);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 32), 4), 4);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 40), 25);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 40), 4), 5);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 48), 27);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 48), 4), 6);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 56), 17);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 56), 4), 7);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 64), 23);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 64), 4), 8);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 72), 18);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 72), 4), 9);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 80), 22);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 80), 4), 10);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 88), 72);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 88), 4), 11);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 96), 4);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 96), 4), 395);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 104), 64);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 104), 4), 405);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 112), 2);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 112), 4), 373);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 120), 5);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 120), 4), 212);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 128), 76);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 128), 4), 402);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 136), 0);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 136), 4), 403);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 144), 13);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 144), 4), 115);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 152), 21);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 152), 4), 114);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 160), 73);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 160), 4), 28);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 168), 84);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 168), 4), 167);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 176), 77);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 176), 4), 207);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 184), 30);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 184), 4), 139);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 192), 14);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 192), 4), 106);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 200), 26);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 200), 4), 105);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 208), 10);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 208), 4), 355);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 216), 12);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 216), 4), 372);
  $M.2 := $store.i32($M.2, $add.ref(encore_enltv_fm53, 224), 71);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53, 224), 4), 142);
  $M.2 := $store.ref($M.2, encore_enltv_fm53_map, $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(encore_enltv_fm53_map, 8), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(encore_enltv_fm53_map, 16), encore_enltv_fm53);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53_map, 16), 8), 29);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53_map, 16), 12), 0);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53_map, 16), 16), 0);
  $M.2 := $store.i64($M.2, $add.ref($add.ref(encore_enltv_fm53_map, 16), 24), 0);
  $M.2 := $store.ref($M.2, $add.ref($add.ref(encore_enltv_fm53_map, 16), 32), .str);
  $M.2 := $store.i32($M.2, $add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 0);
  $M.2 := $store.i32($M.2, $add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 4), 0);
  $M.2 := $store.i32($M.2, $add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 8), 0);
  $M.2 := $store.ref($M.2, $add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 16), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 24), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref($add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 24), 8), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref($add.ref($add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 24), 8), 8), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref($add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 24), 24), $0.ref);
  $M.2 := $store.i32($M.2, $add.ref($add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 24), 32), 0);
  $M.2 := $store.i64($M.2, $add.ref($add.ref($add.ref($add.ref(encore_enltv_fm53_map, 16), 40), 24), 40), 0);
  $exn := false;
  return;
}
